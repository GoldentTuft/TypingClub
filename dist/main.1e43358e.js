...
var $author$project$Typing2$Rule = F2(
	function (input, output) {
		return {input: input, output: output};
	});
var $author$project$Typing2$romanTable = _List_fromArray(
	[
		A2($author$project$Typing2$Rule, '-', 'ー'),
		A2($author$project$Typing2$Rule, '~', '〜'),
		A2($author$project$Typing2$Rule, '.', '。'),
		A2($author$project$Typing2$Rule, ',', '、'),
		A2($author$project$Typing2$Rule, '[', '「'),
		A2($author$project$Typing2$Rule, ']', '」'),
		A2($author$project$Typing2$Rule, 'va', 'ゔぁ'),
		A2($author$project$Typing2$Rule, 'vi', 'ゔぃ'),
		A2($author$project$Typing2$Rule, 'vu', 'ゔ'),
		A2($author$project$Typing2$Rule, 've', 'ゔぇ'),
		A2($author$project$Typing2$Rule, 'vo', 'ゔぉ'),
		A2($author$project$Typing2$Rule, 'vya', 'ゔゃ'),
		A2($author$project$Typing2$Rule, 'vyi', 'ゔぃ'),
		A2($author$project$Typing2$Rule, 'vyu', 'ゔゅ'),
		A2($author$project$Typing2$Rule, 'vye', 'ゔぇ'),
		A2($author$project$Typing2$Rule, 'vyo', 'ゔょ'),
		A2($author$project$Typing2$Rule, 'kya', 'きゃ'),
		A2($author$project$Typing2$Rule, 'kyi', 'きぃ'),
		A2($author$project$Typing2$Rule, 'kyu', 'きゅ'),
		A2($author$project$Typing2$Rule, 'kye', 'きぇ'),
		A2($author$project$Typing2$Rule, 'kyo', 'きょ'),
		A2($author$project$Typing2$Rule, 'gya', 'ぎゃ'),
		A2($author$project$Typing2$Rule, 'gyi', 'ぎぃ'),
		A2($author$project$Typing2$Rule, 'gyu', 'ぎゅ'),
		A2($author$project$Typing2$Rule, 'gye', 'ぎぇ'),
		A2($author$project$Typing2$Rule, 'gyo', 'ぎょ'),
		A2($author$project$Typing2$Rule, 'sya', 'しゃ'),
		A2($author$project$Typing2$Rule, 'syi', 'しぃ'),
		A2($author$project$Typing2$Rule, 'syu', 'しゅ'),
		A2($author$project$Typing2$Rule, 'sye', 'しぇ'),
		A2($author$project$Typing2$Rule, 'syo', 'しょ'),
		A2($author$project$Typing2$Rule, 'sha', 'しゃ'),
		A2($author$project$Typing2$Rule, 'shi', 'し'),
		A2($author$project$Typing2$Rule, 'shu', 'しゅ'),
		A2($author$project$Typing2$Rule, 'she', 'しぇ'),
		A2($author$project$Typing2$Rule, 'sho', 'しょ'),
		A2($author$project$Typing2$Rule, 'zya', 'じゃ'),
		A2($author$project$Typing2$Rule, 'zyi', 'じぃ'),
		A2($author$project$Typing2$Rule, 'zyu', 'じゅ'),
		A2($author$project$Typing2$Rule, 'zye', 'じぇ'),
		A2($author$project$Typing2$Rule, 'zyo', 'じょ'),
		A2($author$project$Typing2$Rule, 'tya', 'ちゃ'),
		A2($author$project$Typing2$Rule, 'tyi', 'ちぃ'),
		A2($author$project$Typing2$Rule, 'tyu', 'ちゅ'),
		A2($author$project$Typing2$Rule, 'tye', 'ちぇ'),
		A2($author$project$Typing2$Rule, 'tyo', 'ちょ'),
		A2($author$project$Typing2$Rule, 'cha', 'ちゃ'),
		A2($author$project$Typing2$Rule, 'chi', 'ち'),
		A2($author$project$Typing2$Rule, 'chu', 'ちゅ'),
		A2($author$project$Typing2$Rule, 'che', 'ちぇ'),
		A2($author$project$Typing2$Rule, 'cho', 'ちょ'),
		A2($author$project$Typing2$Rule, 'cya', 'ちゃ'),
		A2($author$project$Typing2$Rule, 'cyi', 'ちぃ'),
		A2($author$project$Typing2$Rule, 'cyu', 'ちゅ'),
		A2($author$project$Typing2$Rule, 'cye', 'ちぇ'),
		A2($author$project$Typing2$Rule, 'cyo', 'ちょ'),
		A2($author$project$Typing2$Rule, 'dya', 'ぢゃ'),
		A2($author$project$Typing2$Rule, 'dyi', 'ぢぃ'),
		A2($author$project$Typing2$Rule, 'dyu', 'ぢゅ'),
		A2($author$project$Typing2$Rule, 'dye', 'ぢぇ'),
		A2($author$project$Typing2$Rule, 'dyo', 'ぢょ'),
		A2($author$project$Typing2$Rule, 'tsa', 'つぁ'),
		A2($author$project$Typing2$Rule, 'tsi', 'つぃ'),
		A2($author$project$Typing2$Rule, 'tse', 'つぇ'),
		A2($author$project$Typing2$Rule, 'tso', 'つぉ'),
		A2($author$project$Typing2$Rule, 'tha', 'てゃ'),
		A2($author$project$Typing2$Rule, 'thi', 'てぃ'),
		A2($author$project$Typing2$Rule, 'thu', 'てゅ'),
		A2($author$project$Typing2$Rule, 'the', 'てぇ'),
		A2($author$project$Typing2$Rule, 'tho', 'てょ'),
		A2($author$project$Typing2$Rule, 'dha', 'でゃ'),
		A2($author$project$Typing2$Rule, 'dhi', 'でぃ'),
		A2($author$project$Typing2$Rule, 'dhu', 'でゅ'),
		A2($author$project$Typing2$Rule, 'dhe', 'でぇ'),
		A2($author$project$Typing2$Rule, 'dho', 'でょ'),
		A2($author$project$Typing2$Rule, 'twa', 'とぁ'),
		A2($author$project$Typing2$Rule, 'twi', 'とぃ'),
		A2($author$project$Typing2$Rule, 'twu', 'とぅ'),
		A2($author$project$Typing2$Rule, 'twe', 'とぇ'),
		A2($author$project$Typing2$Rule, 'two', 'とぉ'),
		A2($author$project$Typing2$Rule, 'dwa', 'どぁ'),
		A2($author$project$Typing2$Rule, 'dwi', 'どぃ'),
		A2($author$project$Typing2$Rule, 'dwu', 'どぅ'),
		A2($author$project$Typing2$Rule, 'dwe', 'どぇ'),
		A2($author$project$Typing2$Rule, 'dwo', 'どぉ'),
		A2($author$project$Typing2$Rule, 'nya', 'にゃ'),
		A2($author$project$Typing2$Rule, 'nyi', 'にぃ'),
		A2($author$project$Typing2$Rule, 'nyu', 'にゅ'),
		A2($author$project$Typing2$Rule, 'nye', 'にぇ'),
		A2($author$project$Typing2$Rule, 'nyo', 'にょ'),
		A2($author$project$Typing2$Rule, 'hya', 'ひゃ'),
		A2($author$project$Typing2$Rule, 'hyi', 'ひぃ'),
		A2($author$project$Typing2$Rule, 'hyu', 'ひゅ'),
		A2($author$project$Typing2$Rule, 'hye', 'ひぇ'),
		A2($author$project$Typing2$Rule, 'hyo', 'ひょ'),
		A2($author$project$Typing2$Rule, 'bya', 'びゃ'),
		A2($author$project$Typing2$Rule, 'byi', 'びぃ'),
		A2($author$project$Typing2$Rule, 'byu', 'びゅ'),
		A2($author$project$Typing2$Rule, 'bye', 'びぇ'),
		A2($author$project$Typing2$Rule, 'byo', 'びょ'),
		A2($author$project$Typing2$Rule, 'pya', 'ぴゃ'),
		A2($author$project$Typing2$Rule, 'pyi', 'ぴぃ'),
		A2($author$project$Typing2$Rule, 'pyu', 'ぴゅ'),
		A2($author$project$Typing2$Rule, 'pye', 'ぴぇ'),
		A2($author$project$Typing2$Rule, 'pyo', 'ぴょ'),
		A2($author$project$Typing2$Rule, 'fa', 'ふぁ'),
		A2($author$project$Typing2$Rule, 'fi', 'ふぃ'),
		A2($author$project$Typing2$Rule, 'fu', 'ふ'),
		A2($author$project$Typing2$Rule, 'fe', 'ふぇ'),
		A2($author$project$Typing2$Rule, 'fo', 'ふぉ'),
		A2($author$project$Typing2$Rule, 'fya', 'ふゃ'),
		A2($author$project$Typing2$Rule, 'fyu', 'ふゅ'),
		A2($author$project$Typing2$Rule, 'fyo', 'ふょ'),
		A2($author$project$Typing2$Rule, 'mya', 'みゃ'),
		A2($author$project$Typing2$Rule, 'myi', 'みぃ'),
		A2($author$project$Typing2$Rule, 'myu', 'みゅ'),
		A2($author$project$Typing2$Rule, 'mye', 'みぇ'),
		A2($author$project$Typing2$Rule, 'myo', 'みょ'),
		A2($author$project$Typing2$Rule, 'rya', 'りゃ'),
		A2($author$project$Typing2$Rule, 'ryi', 'りぃ'),
		A2($author$project$Typing2$Rule, 'ryu', 'りゅ'),
		A2($author$project$Typing2$Rule, 'rye', 'りぇ'),
		A2($author$project$Typing2$Rule, 'ryo', 'りょ'),
		A2($author$project$Typing2$Rule, 'nn', 'ん'),
		A2($author$project$Typing2$Rule, 'n', 'ん'),
		A2($author$project$Typing2$Rule, 'xn', 'ん'),
		A2($author$project$Typing2$Rule, 'a', 'あ'),
		A2($author$project$Typing2$Rule, 'i', 'い'),
		A2($author$project$Typing2$Rule, 'u', 'う'),
		A2($author$project$Typing2$Rule, 'wu', 'う'),
		A2($author$project$Typing2$Rule, 'e', 'え'),
		A2($author$project$Typing2$Rule, 'o', 'お'),
		A2($author$project$Typing2$Rule, 'xa', 'ぁ'),
		A2($author$project$Typing2$Rule, 'xi', 'ぃ'),
		A2($author$project$Typing2$Rule, 'xu', 'ぅ'),
		A2($author$project$Typing2$Rule, 'xe', 'ぇ'),
		A2($author$project$Typing2$Rule, 'xo', 'ぉ'),
		A2($author$project$Typing2$Rule, 'la', 'ぁ'),
		A2($author$project$Typing2$Rule, 'li', 'ぃ'),
		A2($author$project$Typing2$Rule, 'lu', 'ぅ'),
		A2($author$project$Typing2$Rule, 'le', 'ぇ'),
		A2($author$project$Typing2$Rule, 'lo', 'ぉ'),
		A2($author$project$Typing2$Rule, 'lyi', 'ぃ'),
		A2($author$project$Typing2$Rule, 'xyi', 'ぃ'),
		A2($author$project$Typing2$Rule, 'lye', 'ぇ'),
		A2($author$project$Typing2$Rule, 'xye', 'ぇ'),
		A2($author$project$Typing2$Rule, 'ye', 'いぇ'),
		A2($author$project$Typing2$Rule, 'ka', 'か'),
		A2($author$project$Typing2$Rule, 'ki', 'き'),
		A2($author$project$Typing2$Rule, 'ku', 'く'),
		A2($author$project$Typing2$Rule, 'ke', 'け'),
		A2($author$project$Typing2$Rule, 'ko', 'こ'),
		A2($author$project$Typing2$Rule, 'xka', 'ヵ'),
		A2($author$project$Typing2$Rule, 'xke', 'ヶ'),
		A2($author$project$Typing2$Rule, 'lka', 'ヵ'),
		A2($author$project$Typing2$Rule, 'lke', 'ヶ'),
		A2($author$project$Typing2$Rule, 'ga', 'が'),
		A2($author$project$Typing2$Rule, 'gi', 'ぎ'),
		A2($author$project$Typing2$Rule, 'gu', 'ぐ'),
		A2($author$project$Typing2$Rule, 'ge', 'げ'),
		A2($author$project$Typing2$Rule, 'go', 'ご'),
		A2($author$project$Typing2$Rule, 'sa', 'さ'),
		A2($author$project$Typing2$Rule, 'si', 'し'),
		A2($author$project$Typing2$Rule, 'su', 'す'),
		A2($author$project$Typing2$Rule, 'se', 'せ'),
		A2($author$project$Typing2$Rule, 'so', 'そ'),
		A2($author$project$Typing2$Rule, 'ca', 'か'),
		A2($author$project$Typing2$Rule, 'ci', 'し'),
		A2($author$project$Typing2$Rule, 'cu', 'く'),
		A2($author$project$Typing2$Rule, 'ce', 'せ'),
		A2($author$project$Typing2$Rule, 'co', 'こ'),
		A2($author$project$Typing2$Rule, 'qa', 'くぁ'),
		A2($author$project$Typing2$Rule, 'qi', 'くぃ'),
		A2($author$project$Typing2$Rule, 'qu', 'く'),
		A2($author$project$Typing2$Rule, 'qe', 'くぇ'),
		A2($author$project$Typing2$Rule, 'qo', 'くぉ'),
		A2($author$project$Typing2$Rule, 'kwa', 'くぁ'),
		A2($author$project$Typing2$Rule, 'gwa', 'ぐぁ'),
		A2($author$project$Typing2$Rule, 'gwi', 'ぐぃ'),
		A2($author$project$Typing2$Rule, 'gwu', 'ぐぅ'),
		A2($author$project$Typing2$Rule, 'gwe', 'ぐぇ'),
		A2($author$project$Typing2$Rule, 'gwo', 'ぐぉ'),
		A2($author$project$Typing2$Rule, 'za', 'ざ'),
		A2($author$project$Typing2$Rule, 'zi', 'じ'),
		A2($author$project$Typing2$Rule, 'zu', 'ず'),
		A2($author$project$Typing2$Rule, 'ze', 'ぜ'),
		A2($author$project$Typing2$Rule, 'zo', 'ぞ'),
		A2($author$project$Typing2$Rule, 'ja', 'じゃ'),
		A2($author$project$Typing2$Rule, 'ji', 'じ'),
		A2($author$project$Typing2$Rule, 'ju', 'じゅ'),
		A2($author$project$Typing2$Rule, 'je', 'じぇ'),
		A2($author$project$Typing2$Rule, 'jo', 'じょ'),
		A2($author$project$Typing2$Rule, 'jya', 'じゃ'),
		A2($author$project$Typing2$Rule, 'jyi', 'じぃ'),
		A2($author$project$Typing2$Rule, 'jyu', 'じゅ'),
		A2($author$project$Typing2$Rule, 'jye', 'じぇ'),
		A2($author$project$Typing2$Rule, 'jyo', 'じょ'),
		A2($author$project$Typing2$Rule, 'ta', 'た'),
		A2($author$project$Typing2$Rule, 'ti', 'ち'),
		A2($author$project$Typing2$Rule, 'tu', 'つ'),
		A2($author$project$Typing2$Rule, 'tsu', 'つ'),
		A2($author$project$Typing2$Rule, 'te', 'て'),
		A2($author$project$Typing2$Rule, 'to', 'と'),
		A2($author$project$Typing2$Rule, 'da', 'だ'),
		A2($author$project$Typing2$Rule, 'di', 'ぢ'),
		A2($author$project$Typing2$Rule, 'du', 'づ'),
		A2($author$project$Typing2$Rule, 'de', 'で'),
		A2($author$project$Typing2$Rule, 'do', 'ど'),
		A2($author$project$Typing2$Rule, 'xtu', 'っ'),
		A2($author$project$Typing2$Rule, 'xtsu', 'っ'),
		A2($author$project$Typing2$Rule, 'ltu', 'っ'),
		A2($author$project$Typing2$Rule, 'ltsu', 'っ'),
		A2($author$project$Typing2$Rule, 'na', 'な'),
		A2($author$project$Typing2$Rule, 'ni', 'に'),
		A2($author$project$Typing2$Rule, 'nu', 'ぬ'),
		A2($author$project$Typing2$Rule, 'ne', 'ね'),
		A2($author$project$Typing2$Rule, 'no', 'の'),
		A2($author$project$Typing2$Rule, 'ha', 'は'),
		A2($author$project$Typing2$Rule, 'hi', 'ひ'),
		A2($author$project$Typing2$Rule, 'hu', 'ふ'),
		A2($author$project$Typing2$Rule, 'fu', 'ふ'),
		A2($author$project$Typing2$Rule, 'he', 'へ'),
		A2($author$project$Typing2$Rule, 'ho', 'ほ'),
		A2($author$project$Typing2$Rule, 'ba', 'ば'),
		A2($author$project$Typing2$Rule, 'bi', 'び'),
		A2($author$project$Typing2$Rule, 'bu', 'ぶ'),
		A2($author$project$Typing2$Rule, 'be', 'べ'),
		A2($author$project$Typing2$Rule, 'bo', 'ぼ'),
		A2($author$project$Typing2$Rule, 'pa', 'ぱ'),
		A2($author$project$Typing2$Rule, 'pi', 'ぴ'),
		A2($author$project$Typing2$Rule, 'pu', 'ぷ'),
		A2($author$project$Typing2$Rule, 'pe', 'ぺ'),
		A2($author$project$Typing2$Rule, 'po', 'ぽ'),
		A2($author$project$Typing2$Rule, 'ma', 'ま'),
		A2($author$project$Typing2$Rule, 'mi', 'み'),
		A2($author$project$Typing2$Rule, 'mu', 'む'),
		A2($author$project$Typing2$Rule, 'me', 'め'),
		A2($author$project$Typing2$Rule, 'mo', 'も'),
		A2($author$project$Typing2$Rule, 'xya', 'ゃ'),
		A2($author$project$Typing2$Rule, 'lya', 'ゃ'),
		A2($author$project$Typing2$Rule, 'ya', 'や'),
		A2($author$project$Typing2$Rule, 'wyi', 'ゐ'),
		A2($author$project$Typing2$Rule, 'xyu', 'ゅ'),
		A2($author$project$Typing2$Rule, 'lyu', 'ゅ'),
		A2($author$project$Typing2$Rule, 'yu', 'ゆ'),
		A2($author$project$Typing2$Rule, 'wye', 'ゑ'),
		A2($author$project$Typing2$Rule, 'xyo', 'ょ'),
		A2($author$project$Typing2$Rule, 'lyo', 'ょ'),
		A2($author$project$Typing2$Rule, 'yo', 'よ'),
		A2($author$project$Typing2$Rule, 'ra', 'ら'),
		A2($author$project$Typing2$Rule, 'ri', 'り'),
		A2($author$project$Typing2$Rule, 'ru', 'る'),
		A2($author$project$Typing2$Rule, 're', 'れ'),
		A2($author$project$Typing2$Rule, 'ro', 'ろ'),
		A2($author$project$Typing2$Rule, 'xwa', 'ゎ'),
		A2($author$project$Typing2$Rule, 'lwa', 'ゎ'),
		A2($author$project$Typing2$Rule, 'wa', 'わ'),
		A2($author$project$Typing2$Rule, 'wi', 'うぃ'),
		A2($author$project$Typing2$Rule, 'we', 'うぇ'),
		A2($author$project$Typing2$Rule, 'wo', 'を'),
		A2($author$project$Typing2$Rule, 'wha', 'うぁ'),
		A2($author$project$Typing2$Rule, 'whi', 'うぃ'),
		A2($author$project$Typing2$Rule, 'whu', 'う'),
		A2($author$project$Typing2$Rule, 'whe', 'うぇ'),
		A2($author$project$Typing2$Rule, 'who', 'うぉ'),
		A2($author$project$Typing2$Rule, 'qqa', 'っくぁ'),
		A2($author$project$Typing2$Rule, 'qqi', 'っくぃ'),
		A2($author$project$Typing2$Rule, 'qqu', 'っく'),
		A2($author$project$Typing2$Rule, 'qqe', 'っくぇ'),
		A2($author$project$Typing2$Rule, 'qqo', 'っくぉ'),
		A2($author$project$Typing2$Rule, 'vva', 'っゔぁ'),
		A2($author$project$Typing2$Rule, 'vvi', 'っゔぃ'),
		A2($author$project$Typing2$Rule, 'vvu', 'っゔ'),
		A2($author$project$Typing2$Rule, 'vve', 'っゔぇ'),
		A2($author$project$Typing2$Rule, 'vvo', 'っゔぉ'),
		A2($author$project$Typing2$Rule, 'vvya', 'っゔゃ'),
		A2($author$project$Typing2$Rule, 'vvyi', 'っゔぃ'),
		A2($author$project$Typing2$Rule, 'vvyu', 'っゔゅ'),
		A2($author$project$Typing2$Rule, 'vvye', 'っゔぇ'),
		A2($author$project$Typing2$Rule, 'vvyo', 'っゔょ'),
		A2($author$project$Typing2$Rule, 'lla', 'っぁ'),
		A2($author$project$Typing2$Rule, 'lli', 'っぃ'),
		A2($author$project$Typing2$Rule, 'llu', 'っぅ'),
		A2($author$project$Typing2$Rule, 'lle', 'っぇ'),
		A2($author$project$Typing2$Rule, 'llo', 'っぉ'),
		A2($author$project$Typing2$Rule, 'llyi', 'っぃ'),
		A2($author$project$Typing2$Rule, 'llye', 'っぇ'),
		A2($author$project$Typing2$Rule, 'llka', 'っヵ'),
		A2($author$project$Typing2$Rule, 'llke', 'っヶ'),
		A2($author$project$Typing2$Rule, 'lltu', 'っっ'),
		A2($author$project$Typing2$Rule, 'llya', 'っゃ'),
		A2($author$project$Typing2$Rule, 'llyu', 'っゅ'),
		A2($author$project$Typing2$Rule, 'llyo', 'っょ'),
		A2($author$project$Typing2$Rule, 'llwa', 'っゎ'),
		A2($author$project$Typing2$Rule, 'xxn', 'っん'),
		A2($author$project$Typing2$Rule, 'xxa', 'っぁ'),
		A2($author$project$Typing2$Rule, 'xxi', 'っぃ'),
		A2($author$project$Typing2$Rule, 'xxu', 'っぅ'),
		A2($author$project$Typing2$Rule, 'xxe', 'っぇ'),
		A2($author$project$Typing2$Rule, 'xxo', 'っぉ'),
		A2($author$project$Typing2$Rule, 'xxyi', 'っぃ'),
		A2($author$project$Typing2$Rule, 'xxye', 'っぇ'),
		A2($author$project$Typing2$Rule, 'xxka', 'っヵ'),
		A2($author$project$Typing2$Rule, 'xxke', 'っヶ'),
		A2($author$project$Typing2$Rule, 'xxtu', 'っっ'),
		A2($author$project$Typing2$Rule, 'xxya', 'っゃ'),
		A2($author$project$Typing2$Rule, 'xxyu', 'っゅ'),
		A2($author$project$Typing2$Rule, 'xxyo', 'っょ'),
		A2($author$project$Typing2$Rule, 'xxwa', 'っゎ'),
		A2($author$project$Typing2$Rule, 'kkya', 'っきゃ'),
		A2($author$project$Typing2$Rule, 'kkyi', 'っきぃ'),
		A2($author$project$Typing2$Rule, 'kkyu', 'っきゅ'),
		A2($author$project$Typing2$Rule, 'kkye', 'っきぇ'),
		A2($author$project$Typing2$Rule, 'kkyo', 'っきょ'),
		A2($author$project$Typing2$Rule, 'kka', 'っか'),
		A2($author$project$Typing2$Rule, 'kki', 'っき'),
		A2($author$project$Typing2$Rule, 'kku', 'っく'),
		A2($author$project$Typing2$Rule, 'kke', 'っけ'),
		A2($author$project$Typing2$Rule, 'kko', 'っこ'),
		A2($author$project$Typing2$Rule, 'kkwa', 'っくぁ'),
		A2($author$project$Typing2$Rule, 'ggya', 'っぎゃ'),
		A2($author$project$Typing2$Rule, 'ggyi', 'っぎぃ'),
		A2($author$project$Typing2$Rule, 'ggyu', 'っぎゅ'),
		A2($author$project$Typing2$Rule, 'ggye', 'っぎぇ'),
		A2($author$project$Typing2$Rule, 'ggyo', 'っぎょ'),
		A2($author$project$Typing2$Rule, 'gga', 'っが'),
		A2($author$project$Typing2$Rule, 'ggi', 'っぎ'),
		A2($author$project$Typing2$Rule, 'ggu', 'っぐ'),
		A2($author$project$Typing2$Rule, 'gge', 'っげ'),
		A2($author$project$Typing2$Rule, 'ggo', 'っご'),
		A2($author$project$Typing2$Rule, 'ggwa', 'っぐぁ'),
		A2($author$project$Typing2$Rule, 'ggwi', 'っぐぃ'),
		A2($author$project$Typing2$Rule, 'ggwu', 'っぐぅ'),
		A2($author$project$Typing2$Rule, 'ggwe', 'っぐぇ'),
		A2($author$project$Typing2$Rule, 'ggwo', 'っぐぉ'),
		A2($author$project$Typing2$Rule, 'ssya', 'っしゃ'),
		A2($author$project$Typing2$Rule, 'ssyi', 'っしぃ'),
		A2($author$project$Typing2$Rule, 'ssyu', 'っしゅ'),
		A2($author$project$Typing2$Rule, 'ssye', 'っしぇ'),
		A2($author$project$Typing2$Rule, 'ssyo', 'っしょ'),
		A2($author$project$Typing2$Rule, 'ssha', 'っしゃ'),
		A2($author$project$Typing2$Rule, 'sshi', 'っし'),
		A2($author$project$Typing2$Rule, 'sshu', 'っしゅ'),
		A2($author$project$Typing2$Rule, 'sshe', 'っしぇ'),
		A2($author$project$Typing2$Rule, 'ssho', 'っしょ'),
		A2($author$project$Typing2$Rule, 'ssa', 'っさ'),
		A2($author$project$Typing2$Rule, 'ssi', 'っし'),
		A2($author$project$Typing2$Rule, 'ssu', 'っす'),
		A2($author$project$Typing2$Rule, 'sse', 'っせ'),
		A2($author$project$Typing2$Rule, 'sso', 'っそ'),
		A2($author$project$Typing2$Rule, 'zzya', 'っじゃ'),
		A2($author$project$Typing2$Rule, 'zzyi', 'っじぃ'),
		A2($author$project$Typing2$Rule, 'zzyu', 'っじゅ'),
		A2($author$project$Typing2$Rule, 'zzye', 'っじぇ'),
		A2($author$project$Typing2$Rule, 'zzyo', 'っじょ'),
		A2($author$project$Typing2$Rule, 'zza', 'っざ'),
		A2($author$project$Typing2$Rule, 'zzi', 'っじ'),
		A2($author$project$Typing2$Rule, 'zzu', 'っず'),
		A2($author$project$Typing2$Rule, 'zze', 'っぜ'),
		A2($author$project$Typing2$Rule, 'zzo', 'っぞ'),
		A2($author$project$Typing2$Rule, 'jja', 'っじゃ'),
		A2($author$project$Typing2$Rule, 'jji', 'っじ'),
		A2($author$project$Typing2$Rule, 'jju', 'っじゅ'),
		A2($author$project$Typing2$Rule, 'jje', 'っじぇ'),
		A2($author$project$Typing2$Rule, 'jjo', 'っじょ'),
		A2($author$project$Typing2$Rule, 'jjya', 'っじゃ'),
		A2($author$project$Typing2$Rule, 'jjyi', 'っじぃ'),
		A2($author$project$Typing2$Rule, 'jjyu', 'っじゅ'),
		A2($author$project$Typing2$Rule, 'jjye', 'っじぇ'),
		A2($author$project$Typing2$Rule, 'jjyo', 'っじょ'),
		A2($author$project$Typing2$Rule, 'ttya', 'っちゃ'),
		A2($author$project$Typing2$Rule, 'ttyi', 'っちぃ'),
		A2($author$project$Typing2$Rule, 'ttyu', 'っちゅ'),
		A2($author$project$Typing2$Rule, 'ttye', 'っちぇ'),
		A2($author$project$Typing2$Rule, 'ttyo', 'っちょ'),
		A2($author$project$Typing2$Rule, 'ttsa', 'っつぁ'),
		A2($author$project$Typing2$Rule, 'ttsi', 'っつぃ'),
		A2($author$project$Typing2$Rule, 'ttse', 'っつぇ'),
		A2($author$project$Typing2$Rule, 'ttso', 'っつぉ'),
		A2($author$project$Typing2$Rule, 'ttha', 'ってゃ'),
		A2($author$project$Typing2$Rule, 'tthi', 'ってぃ'),
		A2($author$project$Typing2$Rule, 'tthu', 'ってゅ'),
		A2($author$project$Typing2$Rule, 'tthe', 'ってぇ'),
		A2($author$project$Typing2$Rule, 'ttho', 'ってょ'),
		A2($author$project$Typing2$Rule, 'ttwa', 'っとぁ'),
		A2($author$project$Typing2$Rule, 'ttwi', 'っとぃ'),
		A2($author$project$Typing2$Rule, 'ttwu', 'っとぅ'),
		A2($author$project$Typing2$Rule, 'ttwe', 'っとぇ'),
		A2($author$project$Typing2$Rule, 'ttwo', 'っとぉ'),
		A2($author$project$Typing2$Rule, 'tta', 'った'),
		A2($author$project$Typing2$Rule, 'tti', 'っち'),
		A2($author$project$Typing2$Rule, 'ttu', 'っつ'),
		A2($author$project$Typing2$Rule, 'ttsu', 'っつ'),
		A2($author$project$Typing2$Rule, 'tte', 'って'),
		A2($author$project$Typing2$Rule, 'tto', 'っと'),
		A2($author$project$Typing2$Rule, 'ddya', 'っぢゃ'),
		A2($author$project$Typing2$Rule, 'ddyi', 'っぢぃ'),
		A2($author$project$Typing2$Rule, 'ddyu', 'っぢゅ'),
		A2($author$project$Typing2$Rule, 'ddye', 'っぢぇ'),
		A2($author$project$Typing2$Rule, 'ddyo', 'っぢょ'),
		A2($author$project$Typing2$Rule, 'ddha', 'っでゃ'),
		A2($author$project$Typing2$Rule, 'ddhi', 'っでぃ'),
		A2($author$project$Typing2$Rule, 'ddhu', 'っでゅ'),
		A2($author$project$Typing2$Rule, 'ddhe', 'っでぇ'),
		A2($author$project$Typing2$Rule, 'ddho', 'っでょ'),
		A2($author$project$Typing2$Rule, 'ddwa', 'っどぁ'),
		A2($author$project$Typing2$Rule, 'ddwi', 'っどぃ'),
		A2($author$project$Typing2$Rule, 'ddwu', 'っどぅ'),
		A2($author$project$Typing2$Rule, 'ddwe', 'っどぇ'),
		A2($author$project$Typing2$Rule, 'ddwo', 'っどぉ'),
		A2($author$project$Typing2$Rule, 'dda', 'っだ'),
		A2($author$project$Typing2$Rule, 'ddi', 'っぢ'),
		A2($author$project$Typing2$Rule, 'ddu', 'っづ'),
		A2($author$project$Typing2$Rule, 'dde', 'っで'),
		A2($author$project$Typing2$Rule, 'ddo', 'っど'),
		A2($author$project$Typing2$Rule, 'hhya', 'っひゃ'),
		A2($author$project$Typing2$Rule, 'hhyi', 'っひぃ'),
		A2($author$project$Typing2$Rule, 'hhyu', 'っひゅ'),
		A2($author$project$Typing2$Rule, 'hhye', 'っひぇ'),
		A2($author$project$Typing2$Rule, 'hhyo', 'っひょ'),
		A2($author$project$Typing2$Rule, 'hha', 'っは'),
		A2($author$project$Typing2$Rule, 'hhi', 'っひ'),
		A2($author$project$Typing2$Rule, 'hhu', 'っふ'),
		A2($author$project$Typing2$Rule, 'hhe', 'っへ'),
		A2($author$project$Typing2$Rule, 'hho', 'っほ'),
		A2($author$project$Typing2$Rule, 'ffa', 'っふぁ'),
		A2($author$project$Typing2$Rule, 'ffi', 'っふぃ'),
		A2($author$project$Typing2$Rule, 'ffu', 'っふ'),
		A2($author$project$Typing2$Rule, 'ffe', 'っふぇ'),
		A2($author$project$Typing2$Rule, 'ffo', 'っふぉ'),
		A2($author$project$Typing2$Rule, 'ffya', 'っふゃ'),
		A2($author$project$Typing2$Rule, 'ffyu', 'っふゅ'),
		A2($author$project$Typing2$Rule, 'ffyo', 'っふょ'),
		A2($author$project$Typing2$Rule, 'ffu', 'っふ'),
		A2($author$project$Typing2$Rule, 'bbya', 'っびゃ'),
		A2($author$project$Typing2$Rule, 'bbyi', 'っびぃ'),
		A2($author$project$Typing2$Rule, 'bbyu', 'っびゅ'),
		A2($author$project$Typing2$Rule, 'bbye', 'っびぇ'),
		A2($author$project$Typing2$Rule, 'bbyo', 'っびょ'),
		A2($author$project$Typing2$Rule, 'bba', 'っば'),
		A2($author$project$Typing2$Rule, 'bbi', 'っび'),
		A2($author$project$Typing2$Rule, 'bbu', 'っぶ'),
		A2($author$project$Typing2$Rule, 'bbe', 'っべ'),
		A2($author$project$Typing2$Rule, 'bbo', 'っぼ'),
		A2($author$project$Typing2$Rule, 'ppya', 'っぴゃ'),
		A2($author$project$Typing2$Rule, 'ppyi', 'っぴぃ'),
		A2($author$project$Typing2$Rule, 'ppyu', 'っぴゅ'),
		A2($author$project$Typing2$Rule, 'ppye', 'っぴぇ'),
		A2($author$project$Typing2$Rule, 'ppyo', 'っぴょ'),
		A2($author$project$Typing2$Rule, 'ppa', 'っぱ'),
		A2($author$project$Typing2$Rule, 'ppi', 'っぴ'),
		A2($author$project$Typing2$Rule, 'ppu', 'っぷ'),
		A2($author$project$Typing2$Rule, 'ppe', 'っぺ'),
		A2($author$project$Typing2$Rule, 'ppo', 'っぽ'),
		A2($author$project$Typing2$Rule, 'mmya', 'っみゃ'),
		A2($author$project$Typing2$Rule, 'mmyi', 'っみぃ'),
		A2($author$project$Typing2$Rule, 'mmyu', 'っみゅ'),
		A2($author$project$Typing2$Rule, 'mmye', 'っみぇ'),
		A2($author$project$Typing2$Rule, 'mmyo', 'っみょ'),
		A2($author$project$Typing2$Rule, 'mma', 'っま'),
		A2($author$project$Typing2$Rule, 'mmi', 'っみ'),
		A2($author$project$Typing2$Rule, 'mmu', 'っむ'),
		A2($author$project$Typing2$Rule, 'mme', 'っめ'),
		A2($author$project$Typing2$Rule, 'mmo', 'っも'),
		A2($author$project$Typing2$Rule, 'yye', 'っいぇ'),
		A2($author$project$Typing2$Rule, 'yya', 'っや'),
		A2($author$project$Typing2$Rule, 'yyu', 'っゆ'),
		A2($author$project$Typing2$Rule, 'yyo', 'っよ'),
		A2($author$project$Typing2$Rule, 'rrya', 'っりゃ'),
		A2($author$project$Typing2$Rule, 'rryi', 'っりぃ'),
		A2($author$project$Typing2$Rule, 'rryu', 'っりゅ'),
		A2($author$project$Typing2$Rule, 'rrye', 'っりぇ'),
		A2($author$project$Typing2$Rule, 'rryo', 'っりょ'),
		A2($author$project$Typing2$Rule, 'rra', 'っら'),
		A2($author$project$Typing2$Rule, 'rri', 'っり'),
		A2($author$project$Typing2$Rule, 'rru', 'っる'),
		A2($author$project$Typing2$Rule, 'rre', 'っれ'),
		A2($author$project$Typing2$Rule, 'rro', 'っろ'),
		A2($author$project$Typing2$Rule, 'wwu', 'っう'),
		A2($author$project$Typing2$Rule, 'wwyi', 'っゐ'),
		A2($author$project$Typing2$Rule, 'wwye', 'っゑ'),
		A2($author$project$Typing2$Rule, 'wwa', 'っわ'),
		A2($author$project$Typing2$Rule, 'wwi', 'っうぃ'),
		A2($author$project$Typing2$Rule, 'wwe', 'っうぇ'),
		A2($author$project$Typing2$Rule, 'wwo', 'っを'),
		A2($author$project$Typing2$Rule, 'wwha', 'っうぁ'),
		A2($author$project$Typing2$Rule, 'wwhi', 'っうぃ'),
		A2($author$project$Typing2$Rule, 'wwhu', 'っう'),
		A2($author$project$Typing2$Rule, 'wwhe', 'っうぇ'),
		A2($author$project$Typing2$Rule, 'wwho', 'っうぉ'),
		A2($author$project$Typing2$Rule, 'ccha', 'っちゃ'),
		A2($author$project$Typing2$Rule, 'cchi', 'っち'),
		A2($author$project$Typing2$Rule, 'cchu', 'っちゅ'),
		A2($author$project$Typing2$Rule, 'cche', 'っちぇ'),
		A2($author$project$Typing2$Rule, 'ccho', 'っちょ'),
		A2($author$project$Typing2$Rule, 'ccya', 'っちゃ'),
		A2($author$project$Typing2$Rule, 'ccyi', 'っちぃ'),
		A2($author$project$Typing2$Rule, 'ccyu', 'っちゅ'),
		A2($author$project$Typing2$Rule, 'ccye', 'っちぇ'),
		A2($author$project$Typing2$Rule, 'ccyo', 'っちょ'),
		A2($author$project$Typing2$Rule, 'cca', 'っか'),
		A2($author$project$Typing2$Rule, 'cci', 'っし'),
		A2($author$project$Typing2$Rule, 'ccu', 'っく'),
		A2($author$project$Typing2$Rule, 'cce', 'っせ'),
		A2($author$project$Typing2$Rule, 'cco', 'っこ'),
		A2($author$project$Typing2$Rule, 'a', 'a'),
		A2($author$project$Typing2$Rule, 'b', 'b'),
		A2($author$project$Typing2$Rule, 'c', 'c'),
		A2($author$project$Typing2$Rule, 'd', 'd'),
		A2($author$project$Typing2$Rule, 'e', 'e'),
		A2($author$project$Typing2$Rule, 'f', 'f'),
		A2($author$project$Typing2$Rule, 'g', 'g'),
		A2($author$project$Typing2$Rule, 'h', 'h'),
		A2($author$project$Typing2$Rule, 'i', 'i'),
		A2($author$project$Typing2$Rule, 'j', 'j'),
		A2($author$project$Typing2$Rule, 'k', 'k'),
		A2($author$project$Typing2$Rule, 'l', 'l'),
		A2($author$project$Typing2$Rule, 'm', 'm'),
		A2($author$project$Typing2$Rule, 'n', 'n'),
		A2($author$project$Typing2$Rule, 'o', 'o'),
		A2($author$project$Typing2$Rule, 'p', 'p'),
		A2($author$project$Typing2$Rule, 'q', 'q'),
		A2($author$project$Typing2$Rule, 'r', 'r'),
		A2($author$project$Typing2$Rule, 's', 's'),
		A2($author$project$Typing2$Rule, 't', 't'),
		A2($author$project$Typing2$Rule, 'u', 'u'),
		A2($author$project$Typing2$Rule, 'v', 'v'),
		A2($author$project$Typing2$Rule, 'w', 'w'),
		A2($author$project$Typing2$Rule, 'x', 'x'),
		A2($author$project$Typing2$Rule, 'y', 'y'),
		A2($author$project$Typing2$Rule, 'z', 'z'),
		A2($author$project$Typing2$Rule, 'A', 'A'),
		A2($author$project$Typing2$Rule, 'B', 'B'),
		A2($author$project$Typing2$Rule, 'C', 'C'),
		A2($author$project$Typing2$Rule, 'D', 'D'),
		...
		A2($author$project$Typing2$Rule, 'Y', 'Y'),
		A2($author$project$Typing2$Rule, 'Z', 'Z'),
		A2($author$project$Typing2$Rule, '0', '0'),
		A2($author$project$Typing2$Rule, '1', '1'),
		A2($author$project$Typing2$Rule, '2', '2'),
		A2($author$project$Typing2$Rule, '3', '3'),
		A2($author$project$Typing2$Rule, '4', '4'),
		A2($author$project$Typing2$Rule, '5', '5'),
		A2($author$project$Typing2$Rule, '6', '6'),
		A2($author$project$Typing2$Rule, '7', '7'),
		A2($author$project$Typing2$Rule, '8', '8'),
		A2($author$project$Typing2$Rule, '9', '9'),
		A2($author$project$Typing2$Rule, '`', '`'),
		A2($author$project$Typing2$Rule, '~', '~'),
		A2($author$project$Typing2$Rule, '!', '!'),
		A2($author$project$Typing2$Rule, '@', '@'),
		...
		A2($author$project$Typing2$Rule, ')', ')'),
		A2($author$project$Typing2$Rule, '-', '-'),
		A2($author$project$Typing2$Rule, '_', '_'),
		A2($author$project$Typing2$Rule, '=', '='),
		A2($author$project$Typing2$Rule, '+', '+'),
		A2($author$project$Typing2$Rule, '[', '['),
		A2($author$project$Typing2$Rule, ']', ']'),
...
var $author$project$Typing2$newData = function (words) {
	return $author$project$Typing2$Data(
		{
			convertBuf: A3($author$project$Typing2$ConvertBuf, '', $elm$core$Maybe$Nothing, $author$project$Typing2$romanTable),
			fixedWords: '',
			restWords: words,
...
var $author$project$Page$TypeShortWord$getInputHistory = function (word) {
	return ($elm$core$String$length(word.inputHistory) > 30) ? A2($elm$core$String$right, 30, word.inputHistory) : word.inputHistory;
};
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(
					function () {
						var _v0 = words.missed;
						if (_v0) {
							return 'typing-form__missed';
						} else {
							return 'typing-form';
						}
					}())
					...
					[
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$Maybe$map,
									$author$project$CountDown$getSecond,
									$author$project$Page$TypeShortWord$getCountDownTimer(model)))))
					]))
			]));
};
