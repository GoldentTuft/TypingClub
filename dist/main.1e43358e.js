...
var $author$project$Typing2$PrintRule = F3(
	function (input, output, priority) {
		return {input: input, output: output, priority: priority};
	});
var $author$project$Typing2$defaultPriorities = _List_fromArray(
	[
		A3($author$project$Typing2$PrintRule, 'ji', 'じ', 1),
		A3($author$project$Typing2$PrintRule, 'fu', 'ふ', 1),
		A3($author$project$Typing2$PrintRule, 'ti', 'ち', 1),
		A3($author$project$Typing2$PrintRule, 'si', 'し', 2),
		A3($author$project$Typing2$PrintRule, 'shi', 'し', 1),
		A3($author$project$Typing2$PrintRule, 'tu', 'つ', 1),
		A3($author$project$Typing2$PrintRule, 'n', 'ん', 2),
		A3($author$project$Typing2$PrintRule, 'nn', 'ん', 1),
		A3($author$project$Typing2$PrintRule, 'sya', 'しゃ', 4),
		A3($author$project$Typing2$PrintRule, 'syi', 'しぃ', 4),
		A3($author$project$Typing2$PrintRule, 'syu', 'しゅ', 4),
		A3($author$project$Typing2$PrintRule, 'sye', 'しぇ', 4),
		A3($author$project$Typing2$PrintRule, 'syo', 'しょ', 4),
		A3($author$project$Typing2$PrintRule, 'sha', 'しゃ', 3),
		A3($author$project$Typing2$PrintRule, 'shu', 'しゅ', 3),
		A3($author$project$Typing2$PrintRule, 'she', 'しぇ', 3),
		A3($author$project$Typing2$PrintRule, 'sho', 'しょ', 3),
		A3($author$project$Typing2$PrintRule, 'tya', 'ちゃ', 4),
		A3($author$project$Typing2$PrintRule, 'tyi', 'ちぃ', 4),
		A3($author$project$Typing2$PrintRule, 'tyu', 'ちゅ', 4),
		A3($author$project$Typing2$PrintRule, 'tye', 'ちぇ', 4),
		A3($author$project$Typing2$PrintRule, 'tyo', 'ちょ', 4),
		A3($author$project$Typing2$PrintRule, 'cha', 'ちゃ', 3),
		A3($author$project$Typing2$PrintRule, 'chu', 'ちゅ', 3),
		A3($author$project$Typing2$PrintRule, 'che', 'ちぇ', 3),
		A3($author$project$Typing2$PrintRule, 'cho', 'ちょ', 3),
		A3($author$project$Typing2$PrintRule, 'cya', 'ちゃ', 2),
		A3($author$project$Typing2$PrintRule, 'cyi', 'ちぃ', 2),
		A3($author$project$Typing2$PrintRule, 'cyu', 'ちゅ', 2),
		A3($author$project$Typing2$PrintRule, 'cye', 'ちぇ', 2),
		A3($author$project$Typing2$PrintRule, 'cyo', 'ちょ', 2),
		A3($author$project$Typing2$PrintRule, 'ja', 'じゃ', 4),
		A3($author$project$Typing2$PrintRule, 'jyi', 'じぃ', 4),
		A3($author$project$Typing2$PrintRule, 'ju', 'じゅ', 4),
		A3($author$project$Typing2$PrintRule, 'je', 'じぇ', 4),
		A3($author$project$Typing2$PrintRule, 'jo', 'じょ', 4),
		A3($author$project$Typing2$PrintRule, 'zya', 'じゃ', 3),
		A3($author$project$Typing2$PrintRule, 'zyi', 'じぃ', 3),
		A3($author$project$Typing2$PrintRule, 'zyu', 'じゅ', 3),
		A3($author$project$Typing2$PrintRule, 'zye', 'じぇ', 3),
		A3($author$project$Typing2$PrintRule, 'zyo', 'じょ', 3),
		A3($author$project$Typing2$PrintRule, 'jya', 'じゃ', 2),
		A3($author$project$Typing2$PrintRule, 'jyi', 'じぃ', 2),
		A3($author$project$Typing2$PrintRule, 'jyu', 'じゅ', 2),
		A3($author$project$Typing2$PrintRule, 'jye', 'じぇ', 2),
		A3($author$project$Typing2$PrintRule, 'jyo', 'じょ', 2),
		A3($author$project$Typing2$PrintRule, 'ka', 'か', 1),
		A3($author$project$Typing2$PrintRule, 'ltu', 'っ', -1),
		A3($author$project$Typing2$PrintRule, 'xtu', 'っ', -2),
		A3($author$project$Typing2$PrintRule, 'ltsu', 'っ', -3),
		A3($author$project$Typing2$PrintRule, 'xtsu', 'っ', -4)
	]);
...
var $author$project$Typing2$ConvertBuf = F3(
	function (inputBuffer, tmpFixed, candidates) {
		return {candidates: candidates, inputBuffer: inputBuffer, tmpFixed: tmpFixed};
	});
var $author$project$Typing2$Data = function (a) {
	return {$: 'Data', a: a};
};
var $author$project$Typing2$Waiting = {$: 'Waiting'};
var $author$project$Typing2$newData = F2(
	function (words, rules) {
		return $author$project$Typing2$Data(
			{
				convertBuf: A3($author$project$Typing2$ConvertBuf, '', $elm$core$Maybe$Nothing, rules),
				fixedWords: '',
				history: '',
				restWords: words,
				rules: rules,
				state: $author$project$Typing2$Waiting
			});
	});
...
var $author$project$Typing2$Rule = F3(
	function (input, output, priority) {
		return {input: input, output: output, priority: priority};
	});
var $author$project$Typing2$romanTable = _List_fromArray(
	[
		A3($author$project$Typing2$Rule, '-', 'ー', 0),
		A3($author$project$Typing2$Rule, '~', '〜', 0),
		A3($author$project$Typing2$Rule, '.', '。', 0),
		A3($author$project$Typing2$Rule, ',', '、', 0),
		A3($author$project$Typing2$Rule, '[', '「', 0),
		A3($author$project$Typing2$Rule, ']', '」', 0),
		A3($author$project$Typing2$Rule, 'va', 'ゔぁ', 0),
		A3($author$project$Typing2$Rule, 'vi', 'ゔぃ', 0),
		A3($author$project$Typing2$Rule, 'vu', 'ゔ', 0),
		A3($author$project$Typing2$Rule, 've', 'ゔぇ', 0),
		A3($author$project$Typing2$Rule, 'vo', 'ゔぉ', 0),
		A3($author$project$Typing2$Rule, 'vya', 'ゔゃ', 0),
		A3($author$project$Typing2$Rule, 'vyi', 'ゔぃ', 0),
		A3($author$project$Typing2$Rule, 'vyu', 'ゔゅ', 0),
		A3($author$project$Typing2$Rule, 'vye', 'ゔぇ', 0),
		A3($author$project$Typing2$Rule, 'vyo', 'ゔょ', 0),
		A3($author$project$Typing2$Rule, 'kya', 'きゃ', 0),
		A3($author$project$Typing2$Rule, 'kyi', 'きぃ', 0),
		A3($author$project$Typing2$Rule, 'kyu', 'きゅ', 0),
		A3($author$project$Typing2$Rule, 'kye', 'きぇ', 0),
		A3($author$project$Typing2$Rule, 'kyo', 'きょ', 0),
		A3($author$project$Typing2$Rule, 'gya', 'ぎゃ', 0),
		A3($author$project$Typing2$Rule, 'gyi', 'ぎぃ', 0),
		A3($author$project$Typing2$Rule, 'gyu', 'ぎゅ', 0),
		A3($author$project$Typing2$Rule, 'gye', 'ぎぇ', 0),
		A3($author$project$Typing2$Rule, 'gyo', 'ぎょ', 0),
		A3($author$project$Typing2$Rule, 'sya', 'しゃ', 0),
		A3($author$project$Typing2$Rule, 'syi', 'しぃ', 0),
		A3($author$project$Typing2$Rule, 'syu', 'しゅ', 0),
		A3($author$project$Typing2$Rule, 'sye', 'しぇ', 0),
		A3($author$project$Typing2$Rule, 'syo', 'しょ', 0),
		A3($author$project$Typing2$Rule, 'sha', 'しゃ', 0),
		A3($author$project$Typing2$Rule, 'shi', 'し', 0),
		A3($author$project$Typing2$Rule, 'shu', 'しゅ', 0),
		A3($author$project$Typing2$Rule, 'she', 'しぇ', 0),
		A3($author$project$Typing2$Rule, 'sho', 'しょ', 0),
		A3($author$project$Typing2$Rule, 'zya', 'じゃ', 0),
		A3($author$project$Typing2$Rule, 'zyi', 'じぃ', 0),
		A3($author$project$Typing2$Rule, 'zyu', 'じゅ', 0),
		A3($author$project$Typing2$Rule, 'zye', 'じぇ', 0),
		A3($author$project$Typing2$Rule, 'zyo', 'じょ', 0),
		A3($author$project$Typing2$Rule, 'tya', 'ちゃ', 0),
		A3($author$project$Typing2$Rule, 'tyi', 'ちぃ', 0),
		A3($author$project$Typing2$Rule, 'tyu', 'ちゅ', 0),
		A3($author$project$Typing2$Rule, 'tye', 'ちぇ', 0),
		A3($author$project$Typing2$Rule, 'tyo', 'ちょ', 0),
		A3($author$project$Typing2$Rule, 'cha', 'ちゃ', 0),
		A3($author$project$Typing2$Rule, 'chi', 'ち', 0),
		A3($author$project$Typing2$Rule, 'chu', 'ちゅ', 0),
		A3($author$project$Typing2$Rule, 'che', 'ちぇ', 0),
		A3($author$project$Typing2$Rule, 'cho', 'ちょ', 0),
		A3($author$project$Typing2$Rule, 'cya', 'ちゃ', 0),
		A3($author$project$Typing2$Rule, 'cyi', 'ちぃ', 0),
		A3($author$project$Typing2$Rule, 'cyu', 'ちゅ', 0),
		A3($author$project$Typing2$Rule, 'cye', 'ちぇ', 0),
		A3($author$project$Typing2$Rule, 'cyo', 'ちょ', 0),
		A3($author$project$Typing2$Rule, 'dya', 'ぢゃ', 0),
		A3($author$project$Typing2$Rule, 'dyi', 'ぢぃ', 0),
		A3($author$project$Typing2$Rule, 'dyu', 'ぢゅ', 0),
		A3($author$project$Typing2$Rule, 'dye', 'ぢぇ', 0),
		A3($author$project$Typing2$Rule, 'dyo', 'ぢょ', 0),
		A3($author$project$Typing2$Rule, 'tsa', 'つぁ', 0),
		A3($author$project$Typing2$Rule, 'tsi', 'つぃ', 0),
		A3($author$project$Typing2$Rule, 'tse', 'つぇ', 0),
		A3($author$project$Typing2$Rule, 'tso', 'つぉ', 0),
		A3($author$project$Typing2$Rule, 'tha', 'てゃ', 0),
		A3($author$project$Typing2$Rule, 'thi', 'てぃ', 0),
		A3($author$project$Typing2$Rule, 'thu', 'てゅ', 0),
		A3($author$project$Typing2$Rule, 'the', 'てぇ', 0),
		A3($author$project$Typing2$Rule, 'tho', 'てょ', 0),
		A3($author$project$Typing2$Rule, 'dha', 'でゃ', 0),
		A3($author$project$Typing2$Rule, 'dhi', 'でぃ', 0),
		A3($author$project$Typing2$Rule, 'dhu', 'でゅ', 0),
		A3($author$project$Typing2$Rule, 'dhe', 'でぇ', 0),
		A3($author$project$Typing2$Rule, 'dho', 'でょ', 0),
		A3($author$project$Typing2$Rule, 'twa', 'とぁ', 0),
		A3($author$project$Typing2$Rule, 'twi', 'とぃ', 0),
		A3($author$project$Typing2$Rule, 'twu', 'とぅ', 0),
		A3($author$project$Typing2$Rule, 'twe', 'とぇ', 0),
		A3($author$project$Typing2$Rule, 'two', 'とぉ', 0),
		A3($author$project$Typing2$Rule, 'dwa', 'どぁ', 0),
		A3($author$project$Typing2$Rule, 'dwi', 'どぃ', 0),
		A3($author$project$Typing2$Rule, 'dwu', 'どぅ', 0),
		A3($author$project$Typing2$Rule, 'dwe', 'どぇ', 0),
		A3($author$project$Typing2$Rule, 'dwo', 'どぉ', 0),
		A3($author$project$Typing2$Rule, 'nya', 'にゃ', 0),
		A3($author$project$Typing2$Rule, 'nyi', 'にぃ', 0),
		A3($author$project$Typing2$Rule, 'nyu', 'にゅ', 0),
		A3($author$project$Typing2$Rule, 'nye', 'にぇ', 0),
		A3($author$project$Typing2$Rule, 'nyo', 'にょ', 0),
		A3($author$project$Typing2$Rule, 'hya', 'ひゃ', 0),
		A3($author$project$Typing2$Rule, 'hyi', 'ひぃ', 0),
		A3($author$project$Typing2$Rule, 'hyu', 'ひゅ', 0),
		A3($author$project$Typing2$Rule, 'hye', 'ひぇ', 0),
		A3($author$project$Typing2$Rule, 'hyo', 'ひょ', 0),
		A3($author$project$Typing2$Rule, 'bya', 'びゃ', 0),
		A3($author$project$Typing2$Rule, 'byi', 'びぃ', 0),
		A3($author$project$Typing2$Rule, 'byu', 'びゅ', 0),
		A3($author$project$Typing2$Rule, 'bye', 'びぇ', 0),
		A3($author$project$Typing2$Rule, 'byo', 'びょ', 0),
		A3($author$project$Typing2$Rule, 'pya', 'ぴゃ', 0),
		A3($author$project$Typing2$Rule, 'pyi', 'ぴぃ', 0),
		A3($author$project$Typing2$Rule, 'pyu', 'ぴゅ', 0),
		A3($author$project$Typing2$Rule, 'pye', 'ぴぇ', 0),
		A3($author$project$Typing2$Rule, 'pyo', 'ぴょ', 0),
		A3($author$project$Typing2$Rule, 'fa', 'ふぁ', 0),
		A3($author$project$Typing2$Rule, 'fi', 'ふぃ', 0),
		A3($author$project$Typing2$Rule, 'fu', 'ふ', 0),
		A3($author$project$Typing2$Rule, 'fe', 'ふぇ', 0),
		A3($author$project$Typing2$Rule, 'fo', 'ふぉ', 0),
		A3($author$project$Typing2$Rule, 'fya', 'ふゃ', 0),
		A3($author$project$Typing2$Rule, 'fyu', 'ふゅ', 0),
		A3($author$project$Typing2$Rule, 'fyo', 'ふょ', 0),
		A3($author$project$Typing2$Rule, 'mya', 'みゃ', 0),
		A3($author$project$Typing2$Rule, 'myi', 'みぃ', 0),
		A3($author$project$Typing2$Rule, 'myu', 'みゅ', 0),
		A3($author$project$Typing2$Rule, 'mye', 'みぇ', 0),
		A3($author$project$Typing2$Rule, 'myo', 'みょ', 0),
		A3($author$project$Typing2$Rule, 'rya', 'りゃ', 0),
		A3($author$project$Typing2$Rule, 'ryi', 'りぃ', 0),
		A3($author$project$Typing2$Rule, 'ryu', 'りゅ', 0),
		A3($author$project$Typing2$Rule, 'rye', 'りぇ', 0),
		A3($author$project$Typing2$Rule, 'ryo', 'りょ', 0),
		A3($author$project$Typing2$Rule, 'nn', 'ん', 0),
		A3($author$project$Typing2$Rule, 'n', 'ん', 0),
		A3($author$project$Typing2$Rule, 'xn', 'ん', 0),
		A3($author$project$Typing2$Rule, 'a', 'あ', 0),
		A3($author$project$Typing2$Rule, 'i', 'い', 0),
		A3($author$project$Typing2$Rule, 'u', 'う', 0),
		A3($author$project$Typing2$Rule, 'wu', 'う', 0),
		A3($author$project$Typing2$Rule, 'e', 'え', 0),
		A3($author$project$Typing2$Rule, 'o', 'お', 0),
		A3($author$project$Typing2$Rule, 'xa', 'ぁ', 0),
		A3($author$project$Typing2$Rule, 'xi', 'ぃ', 0),
		A3($author$project$Typing2$Rule, 'xu', 'ぅ', 0),
		A3($author$project$Typing2$Rule, 'xe', 'ぇ', 0),
		A3($author$project$Typing2$Rule, 'xo', 'ぉ', 0),
		A3($author$project$Typing2$Rule, 'la', 'ぁ', 0),
		A3($author$project$Typing2$Rule, 'li', 'ぃ', 0),
		A3($author$project$Typing2$Rule, 'lu', 'ぅ', 0),
		A3($author$project$Typing2$Rule, 'le', 'ぇ', 0),
		A3($author$project$Typing2$Rule, 'lo', 'ぉ', 0),
		A3($author$project$Typing2$Rule, 'lyi', 'ぃ', 0),
		A3($author$project$Typing2$Rule, 'xyi', 'ぃ', 0),
		A3($author$project$Typing2$Rule, 'lye', 'ぇ', 0),
		A3($author$project$Typing2$Rule, 'xye', 'ぇ', 0),
		A3($author$project$Typing2$Rule, 'ye', 'いぇ', 0),
		A3($author$project$Typing2$Rule, 'ka', 'か', 0),
		A3($author$project$Typing2$Rule, 'ki', 'き', 0),
		A3($author$project$Typing2$Rule, 'ku', 'く', 0),
		A3($author$project$Typing2$Rule, 'ke', 'け', 0),
		A3($author$project$Typing2$Rule, 'ko', 'こ', 0),
		A3($author$project$Typing2$Rule, 'xka', 'ヵ', 0),
		A3($author$project$Typing2$Rule, 'xke', 'ヶ', 0),
		A3($author$project$Typing2$Rule, 'lka', 'ヵ', 0),
		A3($author$project$Typing2$Rule, 'lke', 'ヶ', 0),
		A3($author$project$Typing2$Rule, 'ga', 'が', 0),
		A3($author$project$Typing2$Rule, 'gi', 'ぎ', 0),
		A3($author$project$Typing2$Rule, 'gu', 'ぐ', 0),
		A3($author$project$Typing2$Rule, 'ge', 'げ', 0),
		A3($author$project$Typing2$Rule, 'go', 'ご', 0),
		A3($author$project$Typing2$Rule, 'sa', 'さ', 0),
		A3($author$project$Typing2$Rule, 'si', 'し', 0),
		A3($author$project$Typing2$Rule, 'su', 'す', 0),
		A3($author$project$Typing2$Rule, 'se', 'せ', 0),
		A3($author$project$Typing2$Rule, 'so', 'そ', 0),
		A3($author$project$Typing2$Rule, 'ca', 'か', 0),
		A3($author$project$Typing2$Rule, 'ci', 'し', 0),
		A3($author$project$Typing2$Rule, 'cu', 'く', 0),
		A3($author$project$Typing2$Rule, 'ce', 'せ', 0),
		A3($author$project$Typing2$Rule, 'co', 'こ', 0),
		A3($author$project$Typing2$Rule, 'qa', 'くぁ', 0),
		A3($author$project$Typing2$Rule, 'qi', 'くぃ', 0),
		A3($author$project$Typing2$Rule, 'qu', 'く', 0),
		A3($author$project$Typing2$Rule, 'qe', 'くぇ', 0),
		A3($author$project$Typing2$Rule, 'qo', 'くぉ', 0),
		A3($author$project$Typing2$Rule, 'kwa', 'くぁ', 0),
		A3($author$project$Typing2$Rule, 'gwa', 'ぐぁ', 0),
		A3($author$project$Typing2$Rule, 'gwi', 'ぐぃ', 0),
		A3($author$project$Typing2$Rule, 'gwu', 'ぐぅ', 0),
		A3($author$project$Typing2$Rule, 'gwe', 'ぐぇ', 0),
		A3($author$project$Typing2$Rule, 'gwo', 'ぐぉ', 0),
		A3($author$project$Typing2$Rule, 'za', 'ざ', 0),
		A3($author$project$Typing2$Rule, 'zi', 'じ', 0),
		A3($author$project$Typing2$Rule, 'zu', 'ず', 0),
		A3($author$project$Typing2$Rule, 'ze', 'ぜ', 0),
		A3($author$project$Typing2$Rule, 'zo', 'ぞ', 0),
		A3($author$project$Typing2$Rule, 'ja', 'じゃ', 0),
		A3($author$project$Typing2$Rule, 'ji', 'じ', 0),
		A3($author$project$Typing2$Rule, 'ju', 'じゅ', 0),
		A3($author$project$Typing2$Rule, 'je', 'じぇ', 0),
		A3($author$project$Typing2$Rule, 'jo', 'じょ', 0),
		A3($author$project$Typing2$Rule, 'jya', 'じゃ', 0),
		A3($author$project$Typing2$Rule, 'jyi', 'じぃ', 0),
		A3($author$project$Typing2$Rule, 'jyu', 'じゅ', 0),
		A3($author$project$Typing2$Rule, 'jye', 'じぇ', 0),
		A3($author$project$Typing2$Rule, 'jyo', 'じょ', 0),
		A3($author$project$Typing2$Rule, 'ta', 'た', 0),
		A3($author$project$Typing2$Rule, 'ti', 'ち', 0),
		A3($author$project$Typing2$Rule, 'tu', 'つ', 0),
		A3($author$project$Typing2$Rule, 'tsu', 'つ', 0),
		A3($author$project$Typing2$Rule, 'te', 'て', 0),
		A3($author$project$Typing2$Rule, 'to', 'と', 0),
		A3($author$project$Typing2$Rule, 'da', 'だ', 0),
		A3($author$project$Typing2$Rule, 'di', 'ぢ', 0),
		A3($author$project$Typing2$Rule, 'du', 'づ', 0),
		A3($author$project$Typing2$Rule, 'de', 'で', 0),
		A3($author$project$Typing2$Rule, 'do', 'ど', 0),
		A3($author$project$Typing2$Rule, 'xtu', 'っ', 0),
		A3($author$project$Typing2$Rule, 'xtsu', 'っ', 0),
		A3($author$project$Typing2$Rule, 'ltu', 'っ', 0),
		A3($author$project$Typing2$Rule, 'ltsu', 'っ', 0),
		A3($author$project$Typing2$Rule, 'na', 'な', 0),
		A3($author$project$Typing2$Rule, 'ni', 'に', 0),
		A3($author$project$Typing2$Rule, 'nu', 'ぬ', 0),
		A3($author$project$Typing2$Rule, 'ne', 'ね', 0),
		A3($author$project$Typing2$Rule, 'no', 'の', 0),
		A3($author$project$Typing2$Rule, 'ha', 'は', 0),
		A3($author$project$Typing2$Rule, 'hi', 'ひ', 0),
		A3($author$project$Typing2$Rule, 'hu', 'ふ', 0),
		A3($author$project$Typing2$Rule, 'fu', 'ふ', 0),
		A3($author$project$Typing2$Rule, 'he', 'へ', 0),
		A3($author$project$Typing2$Rule, 'ho', 'ほ', 0),
		A3($author$project$Typing2$Rule, 'ba', 'ば', 0),
		A3($author$project$Typing2$Rule, 'bi', 'び', 0),
		A3($author$project$Typing2$Rule, 'bu', 'ぶ', 0),
		A3($author$project$Typing2$Rule, 'be', 'べ', 0),
		A3($author$project$Typing2$Rule, 'bo', 'ぼ', 0),
		A3($author$project$Typing2$Rule, 'pa', 'ぱ', 0),
		A3($author$project$Typing2$Rule, 'pi', 'ぴ', 0),
		A3($author$project$Typing2$Rule, 'pu', 'ぷ', 0),
		A3($author$project$Typing2$Rule, 'pe', 'ぺ', 0),
		A3($author$project$Typing2$Rule, 'po', 'ぽ', 0),
		A3($author$project$Typing2$Rule, 'ma', 'ま', 0),
		A3($author$project$Typing2$Rule, 'mi', 'み', 0),
		A3($author$project$Typing2$Rule, 'mu', 'む', 0),
		A3($author$project$Typing2$Rule, 'me', 'め', 0),
		A3($author$project$Typing2$Rule, 'mo', 'も', 0),
		A3($author$project$Typing2$Rule, 'xya', 'ゃ', 0),
		A3($author$project$Typing2$Rule, 'lya', 'ゃ', 0),
		A3($author$project$Typing2$Rule, 'ya', 'や', 0),
		A3($author$project$Typing2$Rule, 'wyi', 'ゐ', 0),
		A3($author$project$Typing2$Rule, 'xyu', 'ゅ', 0),
		A3($author$project$Typing2$Rule, 'lyu', 'ゅ', 0),
		A3($author$project$Typing2$Rule, 'yu', 'ゆ', 0),
		A3($author$project$Typing2$Rule, 'wye', 'ゑ', 0),
		A3($author$project$Typing2$Rule, 'xyo', 'ょ', 0),
		A3($author$project$Typing2$Rule, 'lyo', 'ょ', 0),
		A3($author$project$Typing2$Rule, 'yo', 'よ', 0),
		A3($author$project$Typing2$Rule, 'ra', 'ら', 0),
		A3($author$project$Typing2$Rule, 'ri', 'り', 0),
		A3($author$project$Typing2$Rule, 'ru', 'る', 0),
		A3($author$project$Typing2$Rule, 're', 'れ', 0),
		A3($author$project$Typing2$Rule, 'ro', 'ろ', 0),
		A3($author$project$Typing2$Rule, 'xwa', 'ゎ', 0),
		A3($author$project$Typing2$Rule, 'lwa', 'ゎ', 0),
		A3($author$project$Typing2$Rule, 'wa', 'わ', 0),
		A3($author$project$Typing2$Rule, 'wi', 'うぃ', 0),
		A3($author$project$Typing2$Rule, 'we', 'うぇ', 0),
		A3($author$project$Typing2$Rule, 'wo', 'を', 0),
		A3($author$project$Typing2$Rule, 'wha', 'うぁ', 0),
		A3($author$project$Typing2$Rule, 'whi', 'うぃ', 0),
		A3($author$project$Typing2$Rule, 'whu', 'う', 0),
		A3($author$project$Typing2$Rule, 'whe', 'うぇ', 0),
		A3($author$project$Typing2$Rule, 'who', 'うぉ', 0),
		A3($author$project$Typing2$Rule, 'qqa', 'っくぁ', 0),
		A3($author$project$Typing2$Rule, 'qqi', 'っくぃ', 0),
		A3($author$project$Typing2$Rule, 'qqu', 'っく', 0),
		A3($author$project$Typing2$Rule, 'qqe', 'っくぇ', 0),
		A3($author$project$Typing2$Rule, 'qqo', 'っくぉ', 0),
		A3($author$project$Typing2$Rule, 'vva', 'っゔぁ', 0),
		A3($author$project$Typing2$Rule, 'vvi', 'っゔぃ', 0),
		A3($author$project$Typing2$Rule, 'vvu', 'っゔ', 0),
		A3($author$project$Typing2$Rule, 'vve', 'っゔぇ', 0),
		A3($author$project$Typing2$Rule, 'vvo', 'っゔぉ', 0),
		A3($author$project$Typing2$Rule, 'vvya', 'っゔゃ', 0),
		A3($author$project$Typing2$Rule, 'vvyi', 'っゔぃ', 0),
		A3($author$project$Typing2$Rule, 'vvyu', 'っゔゅ', 0),
		A3($author$project$Typing2$Rule, 'vvye', 'っゔぇ', 0),
		A3($author$project$Typing2$Rule, 'vvyo', 'っゔょ', 0),
		A3($author$project$Typing2$Rule, 'lla', 'っぁ', 0),
		A3($author$project$Typing2$Rule, 'lli', 'っぃ', 0),
		A3($author$project$Typing2$Rule, 'llu', 'っぅ', 0),
		A3($author$project$Typing2$Rule, 'lle', 'っぇ', 0),
		A3($author$project$Typing2$Rule, 'llo', 'っぉ', 0),
		A3($author$project$Typing2$Rule, 'llyi', 'っぃ', 0),
		A3($author$project$Typing2$Rule, 'llye', 'っぇ', 0),
		A3($author$project$Typing2$Rule, 'llka', 'っヵ', 0),
		A3($author$project$Typing2$Rule, 'llke', 'っヶ', 0),
		A3($author$project$Typing2$Rule, 'lltu', 'っっ', 0),
		A3($author$project$Typing2$Rule, 'llya', 'っゃ', 0),
		A3($author$project$Typing2$Rule, 'llyu', 'っゅ', 0),
		A3($author$project$Typing2$Rule, 'llyo', 'っょ', 0),
		A3($author$project$Typing2$Rule, 'llwa', 'っゎ', 0),
		A3($author$project$Typing2$Rule, 'xxn', 'っん', 0),
		A3($author$project$Typing2$Rule, 'xxa', 'っぁ', 0),
		A3($author$project$Typing2$Rule, 'xxi', 'っぃ', 0),
		A3($author$project$Typing2$Rule, 'xxu', 'っぅ', 0),
		A3($author$project$Typing2$Rule, 'xxe', 'っぇ', 0),
		A3($author$project$Typing2$Rule, 'xxo', 'っぉ', 0),
		A3($author$project$Typing2$Rule, 'xxyi', 'っぃ', 0),
		A3($author$project$Typing2$Rule, 'xxye', 'っぇ', 0),
		A3($author$project$Typing2$Rule, 'xxka', 'っヵ', 0),
		A3($author$project$Typing2$Rule, 'xxke', 'っヶ', 0),
		A3($author$project$Typing2$Rule, 'xxtu', 'っっ', 0),
		A3($author$project$Typing2$Rule, 'xxya', 'っゃ', 0),
		A3($author$project$Typing2$Rule, 'xxyu', 'っゅ', 0),
		A3($author$project$Typing2$Rule, 'xxyo', 'っょ', 0),
		A3($author$project$Typing2$Rule, 'xxwa', 'っゎ', 0),
		A3($author$project$Typing2$Rule, 'kkya', 'っきゃ', 0),
		A3($author$project$Typing2$Rule, 'kkyi', 'っきぃ', 0),
		A3($author$project$Typing2$Rule, 'kkyu', 'っきゅ', 0),
		A3($author$project$Typing2$Rule, 'kkye', 'っきぇ', 0),
		A3($author$project$Typing2$Rule, 'kkyo', 'っきょ', 0),
		A3($author$project$Typing2$Rule, 'kka', 'っか', 0),
		A3($author$project$Typing2$Rule, 'kki', 'っき', 0),
		A3($author$project$Typing2$Rule, 'kku', 'っく', 0),
		A3($author$project$Typing2$Rule, 'kke', 'っけ', 0),
		A3($author$project$Typing2$Rule, 'kko', 'っこ', 0),
		A3($author$project$Typing2$Rule, 'kkwa', 'っくぁ', 0),
		A3($author$project$Typing2$Rule, 'ggya', 'っぎゃ', 0),
		A3($author$project$Typing2$Rule, 'ggyi', 'っぎぃ', 0),
		A3($author$project$Typing2$Rule, 'ggyu', 'っぎゅ', 0),
		A3($author$project$Typing2$Rule, 'ggye', 'っぎぇ', 0),
		A3($author$project$Typing2$Rule, 'ggyo', 'っぎょ', 0),
		A3($author$project$Typing2$Rule, 'gga', 'っが', 0),
		A3($author$project$Typing2$Rule, 'ggi', 'っぎ', 0),
		A3($author$project$Typing2$Rule, 'ggu', 'っぐ', 0),
		A3($author$project$Typing2$Rule, 'gge', 'っげ', 0),
		A3($author$project$Typing2$Rule, 'ggo', 'っご', 0),
		A3($author$project$Typing2$Rule, 'ggwa', 'っぐぁ', 0),
		A3($author$project$Typing2$Rule, 'ggwi', 'っぐぃ', 0),
		A3($author$project$Typing2$Rule, 'ggwu', 'っぐぅ', 0),
		A3($author$project$Typing2$Rule, 'ggwe', 'っぐぇ', 0),
		A3($author$project$Typing2$Rule, 'ggwo', 'っぐぉ', 0),
		A3($author$project$Typing2$Rule, 'ssya', 'っしゃ', 0),
		A3($author$project$Typing2$Rule, 'ssyi', 'っしぃ', 0),
		A3($author$project$Typing2$Rule, 'ssyu', 'っしゅ', 0),
		A3($author$project$Typing2$Rule, 'ssye', 'っしぇ', 0),
		A3($author$project$Typing2$Rule, 'ssyo', 'っしょ', 0),
		A3($author$project$Typing2$Rule, 'ssha', 'っしゃ', 0),
		A3($author$project$Typing2$Rule, 'sshi', 'っし', 0),
		A3($author$project$Typing2$Rule, 'sshu', 'っしゅ', 0),
		A3($author$project$Typing2$Rule, 'sshe', 'っしぇ', 0),
		A3($author$project$Typing2$Rule, 'ssho', 'っしょ', 0),
		A3($author$project$Typing2$Rule, 'ssa', 'っさ', 0),
		A3($author$project$Typing2$Rule, 'ssi', 'っし', 0),
		A3($author$project$Typing2$Rule, 'ssu', 'っす', 0),
		A3($author$project$Typing2$Rule, 'sse', 'っせ', 0),
		A3($author$project$Typing2$Rule, 'sso', 'っそ', 0),
		A3($author$project$Typing2$Rule, 'zzya', 'っじゃ', 0),
		A3($author$project$Typing2$Rule, 'zzyi', 'っじぃ', 0),
		A3($author$project$Typing2$Rule, 'zzyu', 'っじゅ', 0),
		A3($author$project$Typing2$Rule, 'zzye', 'っじぇ', 0),
		A3($author$project$Typing2$Rule, 'zzyo', 'っじょ', 0),
		A3($author$project$Typing2$Rule, 'zza', 'っざ', 0),
		A3($author$project$Typing2$Rule, 'zzi', 'っじ', 0),
		A3($author$project$Typing2$Rule, 'zzu', 'っず', 0),
		A3($author$project$Typing2$Rule, 'zze', 'っぜ', 0),
		A3($author$project$Typing2$Rule, 'zzo', 'っぞ', 0),
		A3($author$project$Typing2$Rule, 'jja', 'っじゃ', 0),
		A3($author$project$Typing2$Rule, 'jji', 'っじ', 0),
		A3($author$project$Typing2$Rule, 'jju', 'っじゅ', 0),
		A3($author$project$Typing2$Rule, 'jje', 'っじぇ', 0),
		A3($author$project$Typing2$Rule, 'jjo', 'っじょ', 0),
		A3($author$project$Typing2$Rule, 'jjya', 'っじゃ', 0),
		A3($author$project$Typing2$Rule, 'jjyi', 'っじぃ', 0),
		A3($author$project$Typing2$Rule, 'jjyu', 'っじゅ', 0),
		A3($author$project$Typing2$Rule, 'jjye', 'っじぇ', 0),
		A3($author$project$Typing2$Rule, 'jjyo', 'っじょ', 0),
		A3($author$project$Typing2$Rule, 'ttya', 'っちゃ', 0),
		A3($author$project$Typing2$Rule, 'ttyi', 'っちぃ', 0),
		A3($author$project$Typing2$Rule, 'ttyu', 'っちゅ', 0),
		A3($author$project$Typing2$Rule, 'ttye', 'っちぇ', 0),
		A3($author$project$Typing2$Rule, 'ttyo', 'っちょ', 0),
		A3($author$project$Typing2$Rule, 'ttsa', 'っつぁ', 0),
		A3($author$project$Typing2$Rule, 'ttsi', 'っつぃ', 0),
		A3($author$project$Typing2$Rule, 'ttse', 'っつぇ', 0),
		A3($author$project$Typing2$Rule, 'ttso', 'っつぉ', 0),
		A3($author$project$Typing2$Rule, 'ttha', 'ってゃ', 0),
		A3($author$project$Typing2$Rule, 'tthi', 'ってぃ', 0),
		A3($author$project$Typing2$Rule, 'tthu', 'ってゅ', 0),
		A3($author$project$Typing2$Rule, 'tthe', 'ってぇ', 0),
		A3($author$project$Typing2$Rule, 'ttho', 'ってょ', 0),
		A3($author$project$Typing2$Rule, 'ttwa', 'っとぁ', 0),
		A3($author$project$Typing2$Rule, 'ttwi', 'っとぃ', 0),
		A3($author$project$Typing2$Rule, 'ttwu', 'っとぅ', 0),
		A3($author$project$Typing2$Rule, 'ttwe', 'っとぇ', 0),
		A3($author$project$Typing2$Rule, 'ttwo', 'っとぉ', 0),
		A3($author$project$Typing2$Rule, 'tta', 'った', 0),
		A3($author$project$Typing2$Rule, 'tti', 'っち', 0),
		A3($author$project$Typing2$Rule, 'ttu', 'っつ', 0),
		A3($author$project$Typing2$Rule, 'ttsu', 'っつ', 0),
		A3($author$project$Typing2$Rule, 'tte', 'って', 0),
		A3($author$project$Typing2$Rule, 'tto', 'っと', 0),
		A3($author$project$Typing2$Rule, 'ddya', 'っぢゃ', 0),
		A3($author$project$Typing2$Rule, 'ddyi', 'っぢぃ', 0),
		A3($author$project$Typing2$Rule, 'ddyu', 'っぢゅ', 0),
		A3($author$project$Typing2$Rule, 'ddye', 'っぢぇ', 0),
		A3($author$project$Typing2$Rule, 'ddyo', 'っぢょ', 0),
		A3($author$project$Typing2$Rule, 'ddha', 'っでゃ', 0),
		A3($author$project$Typing2$Rule, 'ddhi', 'っでぃ', 0),
		A3($author$project$Typing2$Rule, 'ddhu', 'っでゅ', 0),
		A3($author$project$Typing2$Rule, 'ddhe', 'っでぇ', 0),
		A3($author$project$Typing2$Rule, 'ddho', 'っでょ', 0),
		A3($author$project$Typing2$Rule, 'ddwa', 'っどぁ', 0),
		A3($author$project$Typing2$Rule, 'ddwi', 'っどぃ', 0),
		A3($author$project$Typing2$Rule, 'ddwu', 'っどぅ', 0),
		A3($author$project$Typing2$Rule, 'ddwe', 'っどぇ', 0),
		A3($author$project$Typing2$Rule, 'ddwo', 'っどぉ', 0),
		A3($author$project$Typing2$Rule, 'dda', 'っだ', 0),
		A3($author$project$Typing2$Rule, 'ddi', 'っぢ', 0),
		A3($author$project$Typing2$Rule, 'ddu', 'っづ', 0),
		A3($author$project$Typing2$Rule, 'dde', 'っで', 0),
		A3($author$project$Typing2$Rule, 'ddo', 'っど', 0),
		A3($author$project$Typing2$Rule, 'hhya', 'っひゃ', 0),
		A3($author$project$Typing2$Rule, 'hhyi', 'っひぃ', 0),
		A3($author$project$Typing2$Rule, 'hhyu', 'っひゅ', 0),
		A3($author$project$Typing2$Rule, 'hhye', 'っひぇ', 0),
		A3($author$project$Typing2$Rule, 'hhyo', 'っひょ', 0),
		A3($author$project$Typing2$Rule, 'hha', 'っは', 0),
		A3($author$project$Typing2$Rule, 'hhi', 'っひ', 0),
		A3($author$project$Typing2$Rule, 'hhu', 'っふ', 0),
		A3($author$project$Typing2$Rule, 'hhe', 'っへ', 0),
		A3($author$project$Typing2$Rule, 'hho', 'っほ', 0),
		A3($author$project$Typing2$Rule, 'ffa', 'っふぁ', 0),
		A3($author$project$Typing2$Rule, 'ffi', 'っふぃ', 0),
		A3($author$project$Typing2$Rule, 'ffu', 'っふ', 0),
		A3($author$project$Typing2$Rule, 'ffe', 'っふぇ', 0),
		A3($author$project$Typing2$Rule, 'ffo', 'っふぉ', 0),
		A3($author$project$Typing2$Rule, 'ffya', 'っふゃ', 0),
		A3($author$project$Typing2$Rule, 'ffyu', 'っふゅ', 0),
		A3($author$project$Typing2$Rule, 'ffyo', 'っふょ', 0),
		A3($author$project$Typing2$Rule, 'ffu', 'っふ', 0),
		A3($author$project$Typing2$Rule, 'bbya', 'っびゃ', 0),
		A3($author$project$Typing2$Rule, 'bbyi', 'っびぃ', 0),
		A3($author$project$Typing2$Rule, 'bbyu', 'っびゅ', 0),
		A3($author$project$Typing2$Rule, 'bbye', 'っびぇ', 0),
		A3($author$project$Typing2$Rule, 'bbyo', 'っびょ', 0),
		A3($author$project$Typing2$Rule, 'bba', 'っば', 0),
		A3($author$project$Typing2$Rule, 'bbi', 'っび', 0),
		A3($author$project$Typing2$Rule, 'bbu', 'っぶ', 0),
		A3($author$project$Typing2$Rule, 'bbe', 'っべ', 0),
		A3($author$project$Typing2$Rule, 'bbo', 'っぼ', 0),
		A3($author$project$Typing2$Rule, 'ppya', 'っぴゃ', 0),
		A3($author$project$Typing2$Rule, 'ppyi', 'っぴぃ', 0),
		A3($author$project$Typing2$Rule, 'ppyu', 'っぴゅ', 0),
		A3($author$project$Typing2$Rule, 'ppye', 'っぴぇ', 0),
		A3($author$project$Typing2$Rule, 'ppyo', 'っぴょ', 0),
		A3($author$project$Typing2$Rule, 'ppa', 'っぱ', 0),
		A3($author$project$Typing2$Rule, 'ppi', 'っぴ', 0),
		A3($author$project$Typing2$Rule, 'ppu', 'っぷ', 0),
		A3($author$project$Typing2$Rule, 'ppe', 'っぺ', 0),
		A3($author$project$Typing2$Rule, 'ppo', 'っぽ', 0),
		A3($author$project$Typing2$Rule, 'mmya', 'っみゃ', 0),
		A3($author$project$Typing2$Rule, 'mmyi', 'っみぃ', 0),
		A3($author$project$Typing2$Rule, 'mmyu', 'っみゅ', 0),
		A3($author$project$Typing2$Rule, 'mmye', 'っみぇ', 0),
		A3($author$project$Typing2$Rule, 'mmyo', 'っみょ', 0),
		A3($author$project$Typing2$Rule, 'mma', 'っま', 0),
		A3($author$project$Typing2$Rule, 'mmi', 'っみ', 0),
		A3($author$project$Typing2$Rule, 'mmu', 'っむ', 0),
		A3($author$project$Typing2$Rule, 'mme', 'っめ', 0),
		A3($author$project$Typing2$Rule, 'mmo', 'っも', 0),
		A3($author$project$Typing2$Rule, 'yye', 'っいぇ', 0),
		A3($author$project$Typing2$Rule, 'yya', 'っや', 0),
		A3($author$project$Typing2$Rule, 'yyu', 'っゆ', 0),
		A3($author$project$Typing2$Rule, 'yyo', 'っよ', 0),
		A3($author$project$Typing2$Rule, 'rrya', 'っりゃ', 0),
		A3($author$project$Typing2$Rule, 'rryi', 'っりぃ', 0),
		A3($author$project$Typing2$Rule, 'rryu', 'っりゅ', 0),
		A3($author$project$Typing2$Rule, 'rrye', 'っりぇ', 0),
		A3($author$project$Typing2$Rule, 'rryo', 'っりょ', 0),
		A3($author$project$Typing2$Rule, 'rra', 'っら', 0),
		A3($author$project$Typing2$Rule, 'rri', 'っり', 0),
		A3($author$project$Typing2$Rule, 'rru', 'っる', 0),
		A3($author$project$Typing2$Rule, 'rre', 'っれ', 0),
		A3($author$project$Typing2$Rule, 'rro', 'っろ', 0),
		A3($author$project$Typing2$Rule, 'wwu', 'っう', 0),
		A3($author$project$Typing2$Rule, 'wwyi', 'っゐ', 0),
		A3($author$project$Typing2$Rule, 'wwye', 'っゑ', 0),
		A3($author$project$Typing2$Rule, 'wwa', 'っわ', 0),
		A3($author$project$Typing2$Rule, 'wwi', 'っうぃ', 0),
		A3($author$project$Typing2$Rule, 'wwe', 'っうぇ', 0),
		A3($author$project$Typing2$Rule, 'wwo', 'っを', 0),
		A3($author$project$Typing2$Rule, 'wwha', 'っうぁ', 0),
		A3($author$project$Typing2$Rule, 'wwhi', 'っうぃ', 0),
		A3($author$project$Typing2$Rule, 'wwhu', 'っう', 0),
		A3($author$project$Typing2$Rule, 'wwhe', 'っうぇ', 0),
		A3($author$project$Typing2$Rule, 'wwho', 'っうぉ', 0),
		A3($author$project$Typing2$Rule, 'ccha', 'っちゃ', 0),
		A3($author$project$Typing2$Rule, 'cchi', 'っち', 0),
		A3($author$project$Typing2$Rule, 'cchu', 'っちゅ', 0),
		A3($author$project$Typing2$Rule, 'cche', 'っちぇ', 0),
		A3($author$project$Typing2$Rule, 'ccho', 'っちょ', 0),
		A3($author$project$Typing2$Rule, 'ccya', 'っちゃ', 0),
		A3($author$project$Typing2$Rule, 'ccyi', 'っちぃ', 0),
		A3($author$project$Typing2$Rule, 'ccyu', 'っちゅ', 0),
		A3($author$project$Typing2$Rule, 'ccye', 'っちぇ', 0),
		A3($author$project$Typing2$Rule, 'ccyo', 'っちょ', 0),
		A3($author$project$Typing2$Rule, 'cca', 'っか', 0),
		A3($author$project$Typing2$Rule, 'cci', 'っし', 0),
		A3($author$project$Typing2$Rule, 'ccu', 'っく', 0),
		A3($author$project$Typing2$Rule, 'cce', 'っせ', 0),
		A3($author$project$Typing2$Rule, 'cco', 'っこ', 0),
		A3($author$project$Typing2$Rule, 'a', 'a', 0),
		A3($author$project$Typing2$Rule, 'b', 'b', 0),
		A3($author$project$Typing2$Rule, 'c', 'c', 0),
		A3($author$project$Typing2$Rule, 'd', 'd', 0),
		A3($author$project$Typing2$Rule, 'e', 'e', 0),
		A3($author$project$Typing2$Rule, 'f', 'f', 0),
		A3($author$project$Typing2$Rule, 'g', 'g', 0),
		A3($author$project$Typing2$Rule, 'h', 'h', 0),
		A3($author$project$Typing2$Rule, 'i', 'i', 0),
		A3($author$project$Typing2$Rule, 'j', 'j', 0),
		A3($author$project$Typing2$Rule, 'k', 'k', 0),
		A3($author$project$Typing2$Rule, 'l', 'l', 0),
		A3($author$project$Typing2$Rule, 'm', 'm', 0),
		A3($author$project$Typing2$Rule, 'n', 'n', 0),
		A3($author$project$Typing2$Rule, 'o', 'o', 0),
		A3($author$project$Typing2$Rule, 'p', 'p', 0),
		A3($author$project$Typing2$Rule, 'q', 'q', 0),
		A3($author$project$Typing2$Rule, 'r', 'r', 0),
		A3($author$project$Typing2$Rule, 's', 's', 0),
		A3($author$project$Typing2$Rule, 't', 't', 0),
		A3($author$project$Typing2$Rule, 'u', 'u', 0),
		A3($author$project$Typing2$Rule, 'v', 'v', 0),
		A3($author$project$Typing2$Rule, 'w', 'w', 0),
		A3($author$project$Typing2$Rule, 'x', 'x', 0),
		A3($author$project$Typing2$Rule, 'y', 'y', 0),
		A3($author$project$Typing2$Rule, 'z', 'z', 0),
		A3($author$project$Typing2$Rule, 'A', 'A', 0),
		A3($author$project$Typing2$Rule, 'B', 'B', 0),
		A3($author$project$Typing2$Rule, 'C', 'C', 0),
		A3($author$project$Typing2$Rule, 'D', 'D', 0),
		...
		A3($author$project$Typing2$Rule, 'Y', 'Y', 0),
		A3($author$project$Typing2$Rule, 'Z', 'Z', 0),
		A3($author$project$Typing2$Rule, '0', '0', 0),
		A3($author$project$Typing2$Rule, '1', '1', 0),
		A3($author$project$Typing2$Rule, '2', '2', 0),
		A3($author$project$Typing2$Rule, '3', '3', 0),
		A3($author$project$Typing2$Rule, '4', '4', 0),
		A3($author$project$Typing2$Rule, '5', '5', 0),
		A3($author$project$Typing2$Rule, '6', '6', 0),
		A3($author$project$Typing2$Rule, '7', '7', 0),
		A3($author$project$Typing2$Rule, '8', '8', 0),
		A3($author$project$Typing2$Rule, '9', '9', 0),
		A3($author$project$Typing2$Rule, '`', '`', 0),
		A3($author$project$Typing2$Rule, '~', '~', 0),
		A3($author$project$Typing2$Rule, '!', '!', 0),
		A3($author$project$Typing2$Rule, '@', '@', 0),
		...
		A3($author$project$Typing2$Rule, ')', ')', 0),
		A3($author$project$Typing2$Rule, '-', '-', 0),
		A3($author$project$Typing2$Rule, '_', '_', 0),
		A3($author$project$Typing2$Rule, '=', '=', 0),
		A3($author$project$Typing2$Rule, '+', '+', 0),
		A3($author$project$Typing2$Rule, '[', '[', 0),
		A3($author$project$Typing2$Rule, ']', ']', 0),
...
var $author$project$Typing2$setPriorities = F2(
			...
			A2(
				...
				function (rule) {
					return _Utils_update(
						rule,
						{
							priority: A2(getPriority, rule, printRules)
						});
				},
				rules));
	});
var $author$project$Page$TypeShortWord$initCustomTypingWords = function (words) {
	var printRules = A2($author$project$Typing2$setPriorities, $author$project$Typing2$defaultPriorities, $author$project$Typing2$romanTable);
	...
	var fun = function (_v0) {
		...
		return {
			...
			typingData: A2($author$project$Typing2$newData, d.wordForInput, printRules),
...
var $author$project$Typing$Data = F3(
	function (fixedWords, restWords, state) {
		return {fixedWords: fixedWords, restWords: restWords, state: state};
	});
var $author$project$Typing$State = F3(
	function (inputBuffer, tmpFixed, candidates) {
		return {candidates: candidates, inputBuffer: inputBuffer, tmpFixed: tmpFixed};
	});
var $author$project$Typing$Rule = F2(
	function (input, output) {
		return {input: input, output: output};
	});
var $author$project$Typing$romanTable = _List_fromArray(
	[
		A2($author$project$Typing$Rule, '-', 'ー'),
		A2($author$project$Typing$Rule, '~', '〜'),
		A2($author$project$Typing$Rule, '.', '。'),
		A2($author$project$Typing$Rule, ',', '、'),
		A2($author$project$Typing$Rule, '[', '「'),
		A2($author$project$Typing$Rule, ']', '」'),
		A2($author$project$Typing$Rule, 'va', 'ゔぁ'),
		A2($author$project$Typing$Rule, 'vi', 'ゔぃ'),
		A2($author$project$Typing$Rule, 'vu', 'ゔ'),
		A2($author$project$Typing$Rule, 've', 'ゔぇ'),
		A2($author$project$Typing$Rule, 'vo', 'ゔぉ'),
		A2($author$project$Typing$Rule, 'vya', 'ゔゃ'),
		A2($author$project$Typing$Rule, 'vyi', 'ゔぃ'),
		A2($author$project$Typing$Rule, 'vyu', 'ゔゅ'),
		A2($author$project$Typing$Rule, 'vye', 'ゔぇ'),
		A2($author$project$Typing$Rule, 'vyo', 'ゔょ'),
		A2($author$project$Typing$Rule, 'kya', 'きゃ'),
		A2($author$project$Typing$Rule, 'kyi', 'きぃ'),
		A2($author$project$Typing$Rule, 'kyu', 'きゅ'),
		A2($author$project$Typing$Rule, 'kye', 'きぇ'),
		A2($author$project$Typing$Rule, 'kyo', 'きょ'),
		A2($author$project$Typing$Rule, 'gya', 'ぎゃ'),
		A2($author$project$Typing$Rule, 'gyi', 'ぎぃ'),
		A2($author$project$Typing$Rule, 'gyu', 'ぎゅ'),
		A2($author$project$Typing$Rule, 'gye', 'ぎぇ'),
		A2($author$project$Typing$Rule, 'gyo', 'ぎょ'),
		A2($author$project$Typing$Rule, 'sya', 'しゃ'),
		A2($author$project$Typing$Rule, 'syi', 'しぃ'),
		A2($author$project$Typing$Rule, 'syu', 'しゅ'),
		A2($author$project$Typing$Rule, 'sye', 'しぇ'),
		A2($author$project$Typing$Rule, 'syo', 'しょ'),
		A2($author$project$Typing$Rule, 'sha', 'しゃ'),
		A2($author$project$Typing$Rule, 'shi', 'し'),
		A2($author$project$Typing$Rule, 'shu', 'しゅ'),
		A2($author$project$Typing$Rule, 'she', 'しぇ'),
		A2($author$project$Typing$Rule, 'sho', 'しょ'),
		A2($author$project$Typing$Rule, 'zya', 'じゃ'),
		A2($author$project$Typing$Rule, 'zyi', 'じぃ'),
		A2($author$project$Typing$Rule, 'zyu', 'じゅ'),
		A2($author$project$Typing$Rule, 'zye', 'じぇ'),
		A2($author$project$Typing$Rule, 'zyo', 'じょ'),
		A2($author$project$Typing$Rule, 'tya', 'ちゃ'),
		A2($author$project$Typing$Rule, 'tyi', 'ちぃ'),
		A2($author$project$Typing$Rule, 'tyu', 'ちゅ'),
		A2($author$project$Typing$Rule, 'tye', 'ちぇ'),
		A2($author$project$Typing$Rule, 'tyo', 'ちょ'),
		A2($author$project$Typing$Rule, 'cha', 'ちゃ'),
		A2($author$project$Typing$Rule, 'chi', 'ち'),
		A2($author$project$Typing$Rule, 'chu', 'ちゅ'),
		A2($author$project$Typing$Rule, 'che', 'ちぇ'),
		A2($author$project$Typing$Rule, 'cho', 'ちょ'),
		A2($author$project$Typing$Rule, 'cya', 'ちゃ'),
		A2($author$project$Typing$Rule, 'cyi', 'ちぃ'),
		A2($author$project$Typing$Rule, 'cyu', 'ちゅ'),
		A2($author$project$Typing$Rule, 'cye', 'ちぇ'),
		A2($author$project$Typing$Rule, 'cyo', 'ちょ'),
		A2($author$project$Typing$Rule, 'dya', 'ぢゃ'),
		A2($author$project$Typing$Rule, 'dyi', 'ぢぃ'),
		A2($author$project$Typing$Rule, 'dyu', 'ぢゅ'),
		A2($author$project$Typing$Rule, 'dye', 'ぢぇ'),
		A2($author$project$Typing$Rule, 'dyo', 'ぢょ'),
		A2($author$project$Typing$Rule, 'tsa', 'つぁ'),
		A2($author$project$Typing$Rule, 'tsi', 'つぃ'),
		A2($author$project$Typing$Rule, 'tse', 'つぇ'),
		A2($author$project$Typing$Rule, 'tso', 'つぉ'),
		A2($author$project$Typing$Rule, 'tha', 'てゃ'),
		A2($author$project$Typing$Rule, 'thi', 'てぃ'),
		A2($author$project$Typing$Rule, 'thu', 'てゅ'),
		A2($author$project$Typing$Rule, 'the', 'てぇ'),
		A2($author$project$Typing$Rule, 'tho', 'てょ'),
		A2($author$project$Typing$Rule, 'dha', 'でゃ'),
		A2($author$project$Typing$Rule, 'dhi', 'でぃ'),
		A2($author$project$Typing$Rule, 'dhu', 'でゅ'),
		A2($author$project$Typing$Rule, 'dhe', 'でぇ'),
		A2($author$project$Typing$Rule, 'dho', 'でょ'),
		A2($author$project$Typing$Rule, 'twa', 'とぁ'),
		A2($author$project$Typing$Rule, 'twi', 'とぃ'),
		A2($author$project$Typing$Rule, 'twu', 'とぅ'),
		A2($author$project$Typing$Rule, 'twe', 'とぇ'),
		A2($author$project$Typing$Rule, 'two', 'とぉ'),
		A2($author$project$Typing$Rule, 'dwa', 'どぁ'),
		A2($author$project$Typing$Rule, 'dwi', 'どぃ'),
		A2($author$project$Typing$Rule, 'dwu', 'どぅ'),
		A2($author$project$Typing$Rule, 'dwe', 'どぇ'),
		A2($author$project$Typing$Rule, 'dwo', 'どぉ'),
		A2($author$project$Typing$Rule, 'nya', 'にゃ'),
		A2($author$project$Typing$Rule, 'nyi', 'にぃ'),
		A2($author$project$Typing$Rule, 'nyu', 'にゅ'),
		A2($author$project$Typing$Rule, 'nye', 'にぇ'),
		A2($author$project$Typing$Rule, 'nyo', 'にょ'),
		A2($author$project$Typing$Rule, 'hya', 'ひゃ'),
		A2($author$project$Typing$Rule, 'hyi', 'ひぃ'),
		A2($author$project$Typing$Rule, 'hyu', 'ひゅ'),
		A2($author$project$Typing$Rule, 'hye', 'ひぇ'),
		A2($author$project$Typing$Rule, 'hyo', 'ひょ'),
		A2($author$project$Typing$Rule, 'bya', 'びゃ'),
		A2($author$project$Typing$Rule, 'byi', 'びぃ'),
		A2($author$project$Typing$Rule, 'byu', 'びゅ'),
		A2($author$project$Typing$Rule, 'bye', 'びぇ'),
		A2($author$project$Typing$Rule, 'byo', 'びょ'),
		A2($author$project$Typing$Rule, 'pya', 'ぴゃ'),
		A2($author$project$Typing$Rule, 'pyi', 'ぴぃ'),
		A2($author$project$Typing$Rule, 'pyu', 'ぴゅ'),
		A2($author$project$Typing$Rule, 'pye', 'ぴぇ'),
		A2($author$project$Typing$Rule, 'pyo', 'ぴょ'),
		A2($author$project$Typing$Rule, 'fa', 'ふぁ'),
		A2($author$project$Typing$Rule, 'fi', 'ふぃ'),
		A2($author$project$Typing$Rule, 'fu', 'ふ'),
		A2($author$project$Typing$Rule, 'fe', 'ふぇ'),
		A2($author$project$Typing$Rule, 'fo', 'ふぉ'),
		A2($author$project$Typing$Rule, 'fya', 'ふゃ'),
		A2($author$project$Typing$Rule, 'fyu', 'ふゅ'),
		A2($author$project$Typing$Rule, 'fyo', 'ふょ'),
		A2($author$project$Typing$Rule, 'mya', 'みゃ'),
		A2($author$project$Typing$Rule, 'myi', 'みぃ'),
		A2($author$project$Typing$Rule, 'myu', 'みゅ'),
		A2($author$project$Typing$Rule, 'mye', 'みぇ'),
		A2($author$project$Typing$Rule, 'myo', 'みょ'),
		A2($author$project$Typing$Rule, 'rya', 'りゃ'),
		A2($author$project$Typing$Rule, 'ryi', 'りぃ'),
		A2($author$project$Typing$Rule, 'ryu', 'りゅ'),
		A2($author$project$Typing$Rule, 'rye', 'りぇ'),
		A2($author$project$Typing$Rule, 'ryo', 'りょ'),
		A2($author$project$Typing$Rule, 'nn', 'ん'),
		A2($author$project$Typing$Rule, 'n', 'ん'),
		A2($author$project$Typing$Rule, 'xn', 'ん'),
		A2($author$project$Typing$Rule, 'a', 'あ'),
		A2($author$project$Typing$Rule, 'i', 'い'),
		A2($author$project$Typing$Rule, 'u', 'う'),
		A2($author$project$Typing$Rule, 'wu', 'う'),
		A2($author$project$Typing$Rule, 'e', 'え'),
		A2($author$project$Typing$Rule, 'o', 'お'),
		A2($author$project$Typing$Rule, 'xa', 'ぁ'),
		A2($author$project$Typing$Rule, 'xi', 'ぃ'),
		A2($author$project$Typing$Rule, 'xu', 'ぅ'),
		A2($author$project$Typing$Rule, 'xe', 'ぇ'),
		A2($author$project$Typing$Rule, 'xo', 'ぉ'),
		A2($author$project$Typing$Rule, 'la', 'ぁ'),
		A2($author$project$Typing$Rule, 'li', 'ぃ'),
		A2($author$project$Typing$Rule, 'lu', 'ぅ'),
		A2($author$project$Typing$Rule, 'le', 'ぇ'),
		A2($author$project$Typing$Rule, 'lo', 'ぉ'),
		A2($author$project$Typing$Rule, 'lyi', 'ぃ'),
		A2($author$project$Typing$Rule, 'xyi', 'ぃ'),
		A2($author$project$Typing$Rule, 'lye', 'ぇ'),
		A2($author$project$Typing$Rule, 'xye', 'ぇ'),
		A2($author$project$Typing$Rule, 'ye', 'いぇ'),
		A2($author$project$Typing$Rule, 'ka', 'か'),
		A2($author$project$Typing$Rule, 'ki', 'き'),
		A2($author$project$Typing$Rule, 'ku', 'く'),
		A2($author$project$Typing$Rule, 'ke', 'け'),
		A2($author$project$Typing$Rule, 'ko', 'こ'),
		A2($author$project$Typing$Rule, 'xka', 'ヵ'),
		A2($author$project$Typing$Rule, 'xke', 'ヶ'),
		A2($author$project$Typing$Rule, 'lka', 'ヵ'),
		A2($author$project$Typing$Rule, 'lke', 'ヶ'),
		A2($author$project$Typing$Rule, 'ga', 'が'),
		A2($author$project$Typing$Rule, 'gi', 'ぎ'),
		A2($author$project$Typing$Rule, 'gu', 'ぐ'),
		A2($author$project$Typing$Rule, 'ge', 'げ'),
		A2($author$project$Typing$Rule, 'go', 'ご'),
		A2($author$project$Typing$Rule, 'sa', 'さ'),
		A2($author$project$Typing$Rule, 'si', 'し'),
		A2($author$project$Typing$Rule, 'su', 'す'),
		A2($author$project$Typing$Rule, 'se', 'せ'),
		A2($author$project$Typing$Rule, 'so', 'そ'),
		A2($author$project$Typing$Rule, 'ca', 'か'),
		A2($author$project$Typing$Rule, 'ci', 'し'),
		A2($author$project$Typing$Rule, 'cu', 'く'),
		A2($author$project$Typing$Rule, 'ce', 'せ'),
		A2($author$project$Typing$Rule, 'co', 'こ'),
		A2($author$project$Typing$Rule, 'qa', 'くぁ'),
		A2($author$project$Typing$Rule, 'qi', 'くぃ'),
		A2($author$project$Typing$Rule, 'qu', 'く'),
		A2($author$project$Typing$Rule, 'qe', 'くぇ'),
		A2($author$project$Typing$Rule, 'qo', 'くぉ'),
		A2($author$project$Typing$Rule, 'kwa', 'くぁ'),
		A2($author$project$Typing$Rule, 'gwa', 'ぐぁ'),
		A2($author$project$Typing$Rule, 'gwi', 'ぐぃ'),
		A2($author$project$Typing$Rule, 'gwu', 'ぐぅ'),
		A2($author$project$Typing$Rule, 'gwe', 'ぐぇ'),
		A2($author$project$Typing$Rule, 'gwo', 'ぐぉ'),
		A2($author$project$Typing$Rule, 'za', 'ざ'),
		A2($author$project$Typing$Rule, 'zi', 'じ'),
		A2($author$project$Typing$Rule, 'zu', 'ず'),
		A2($author$project$Typing$Rule, 'ze', 'ぜ'),
		A2($author$project$Typing$Rule, 'zo', 'ぞ'),
		A2($author$project$Typing$Rule, 'ja', 'じゃ'),
		A2($author$project$Typing$Rule, 'ji', 'じ'),
		A2($author$project$Typing$Rule, 'ju', 'じゅ'),
		A2($author$project$Typing$Rule, 'je', 'じぇ'),
		A2($author$project$Typing$Rule, 'jo', 'じょ'),
		A2($author$project$Typing$Rule, 'jya', 'じゃ'),
		A2($author$project$Typing$Rule, 'jyi', 'じぃ'),
		A2($author$project$Typing$Rule, 'jyu', 'じゅ'),
		A2($author$project$Typing$Rule, 'jye', 'じぇ'),
		A2($author$project$Typing$Rule, 'jyo', 'じょ'),
		A2($author$project$Typing$Rule, 'ta', 'た'),
		A2($author$project$Typing$Rule, 'ti', 'ち'),
		A2($author$project$Typing$Rule, 'tu', 'つ'),
		A2($author$project$Typing$Rule, 'tsu', 'つ'),
		A2($author$project$Typing$Rule, 'te', 'て'),
		A2($author$project$Typing$Rule, 'to', 'と'),
		A2($author$project$Typing$Rule, 'da', 'だ'),
		A2($author$project$Typing$Rule, 'di', 'ぢ'),
		A2($author$project$Typing$Rule, 'du', 'づ'),
		A2($author$project$Typing$Rule, 'de', 'で'),
		A2($author$project$Typing$Rule, 'do', 'ど'),
		A2($author$project$Typing$Rule, 'xtu', 'っ'),
		A2($author$project$Typing$Rule, 'xtsu', 'っ'),
		A2($author$project$Typing$Rule, 'ltu', 'っ'),
		A2($author$project$Typing$Rule, 'ltsu', 'っ'),
		A2($author$project$Typing$Rule, 'na', 'な'),
		A2($author$project$Typing$Rule, 'ni', 'に'),
		A2($author$project$Typing$Rule, 'nu', 'ぬ'),
		A2($author$project$Typing$Rule, 'ne', 'ね'),
		A2($author$project$Typing$Rule, 'no', 'の'),
		A2($author$project$Typing$Rule, 'ha', 'は'),
		A2($author$project$Typing$Rule, 'hi', 'ひ'),
		A2($author$project$Typing$Rule, 'hu', 'ふ'),
		A2($author$project$Typing$Rule, 'fu', 'ふ'),
		A2($author$project$Typing$Rule, 'he', 'へ'),
		A2($author$project$Typing$Rule, 'ho', 'ほ'),
		A2($author$project$Typing$Rule, 'ba', 'ば'),
		A2($author$project$Typing$Rule, 'bi', 'び'),
		A2($author$project$Typing$Rule, 'bu', 'ぶ'),
		A2($author$project$Typing$Rule, 'be', 'べ'),
		A2($author$project$Typing$Rule, 'bo', 'ぼ'),
		A2($author$project$Typing$Rule, 'pa', 'ぱ'),
		A2($author$project$Typing$Rule, 'pi', 'ぴ'),
		A2($author$project$Typing$Rule, 'pu', 'ぷ'),
		A2($author$project$Typing$Rule, 'pe', 'ぺ'),
		A2($author$project$Typing$Rule, 'po', 'ぽ'),
		A2($author$project$Typing$Rule, 'ma', 'ま'),
		A2($author$project$Typing$Rule, 'mi', 'み'),
		A2($author$project$Typing$Rule, 'mu', 'む'),
		A2($author$project$Typing$Rule, 'me', 'め'),
		A2($author$project$Typing$Rule, 'mo', 'も'),
		A2($author$project$Typing$Rule, 'xya', 'ゃ'),
		A2($author$project$Typing$Rule, 'lya', 'ゃ'),
		A2($author$project$Typing$Rule, 'ya', 'や'),
		A2($author$project$Typing$Rule, 'wyi', 'ゐ'),
		A2($author$project$Typing$Rule, 'xyu', 'ゅ'),
		A2($author$project$Typing$Rule, 'lyu', 'ゅ'),
		A2($author$project$Typing$Rule, 'yu', 'ゆ'),
		A2($author$project$Typing$Rule, 'wye', 'ゑ'),
		A2($author$project$Typing$Rule, 'xyo', 'ょ'),
		A2($author$project$Typing$Rule, 'lyo', 'ょ'),
		A2($author$project$Typing$Rule, 'yo', 'よ'),
		A2($author$project$Typing$Rule, 'ra', 'ら'),
		A2($author$project$Typing$Rule, 'ri', 'り'),
		A2($author$project$Typing$Rule, 'ru', 'る'),
		A2($author$project$Typing$Rule, 're', 'れ'),
		A2($author$project$Typing$Rule, 'ro', 'ろ'),
		A2($author$project$Typing$Rule, 'xwa', 'ゎ'),
		A2($author$project$Typing$Rule, 'lwa', 'ゎ'),
		A2($author$project$Typing$Rule, 'wa', 'わ'),
		A2($author$project$Typing$Rule, 'wi', 'うぃ'),
		A2($author$project$Typing$Rule, 'we', 'うぇ'),
		A2($author$project$Typing$Rule, 'wo', 'を'),
		A2($author$project$Typing$Rule, 'wha', 'うぁ'),
		A2($author$project$Typing$Rule, 'whi', 'うぃ'),
		A2($author$project$Typing$Rule, 'whu', 'う'),
		A2($author$project$Typing$Rule, 'whe', 'うぇ'),
		A2($author$project$Typing$Rule, 'who', 'うぉ'),
		A2($author$project$Typing$Rule, 'qqa', 'っくぁ'),
		A2($author$project$Typing$Rule, 'qqi', 'っくぃ'),
		A2($author$project$Typing$Rule, 'qqu', 'っく'),
		A2($author$project$Typing$Rule, 'qqe', 'っくぇ'),
		A2($author$project$Typing$Rule, 'qqo', 'っくぉ'),
		A2($author$project$Typing$Rule, 'vva', 'っゔぁ'),
		A2($author$project$Typing$Rule, 'vvi', 'っゔぃ'),
		A2($author$project$Typing$Rule, 'vvu', 'っゔ'),
		A2($author$project$Typing$Rule, 'vve', 'っゔぇ'),
		A2($author$project$Typing$Rule, 'vvo', 'っゔぉ'),
		A2($author$project$Typing$Rule, 'vvya', 'っゔゃ'),
		A2($author$project$Typing$Rule, 'vvyi', 'っゔぃ'),
		A2($author$project$Typing$Rule, 'vvyu', 'っゔゅ'),
		A2($author$project$Typing$Rule, 'vvye', 'っゔぇ'),
		A2($author$project$Typing$Rule, 'vvyo', 'っゔょ'),
		A2($author$project$Typing$Rule, 'lla', 'っぁ'),
		A2($author$project$Typing$Rule, 'lli', 'っぃ'),
		A2($author$project$Typing$Rule, 'llu', 'っぅ'),
		A2($author$project$Typing$Rule, 'lle', 'っぇ'),
		A2($author$project$Typing$Rule, 'llo', 'っぉ'),
		A2($author$project$Typing$Rule, 'llyi', 'っぃ'),
		A2($author$project$Typing$Rule, 'llye', 'っぇ'),
		A2($author$project$Typing$Rule, 'llka', 'っヵ'),
		A2($author$project$Typing$Rule, 'llke', 'っヶ'),
		A2($author$project$Typing$Rule, 'lltu', 'っっ'),
		A2($author$project$Typing$Rule, 'llya', 'っゃ'),
		A2($author$project$Typing$Rule, 'llyu', 'っゅ'),
		A2($author$project$Typing$Rule, 'llyo', 'っょ'),
		A2($author$project$Typing$Rule, 'llwa', 'っゎ'),
		A2($author$project$Typing$Rule, 'xxn', 'っん'),
		A2($author$project$Typing$Rule, 'xxa', 'っぁ'),
		A2($author$project$Typing$Rule, 'xxi', 'っぃ'),
		A2($author$project$Typing$Rule, 'xxu', 'っぅ'),
		A2($author$project$Typing$Rule, 'xxe', 'っぇ'),
		A2($author$project$Typing$Rule, 'xxo', 'っぉ'),
		A2($author$project$Typing$Rule, 'xxyi', 'っぃ'),
		A2($author$project$Typing$Rule, 'xxye', 'っぇ'),
		A2($author$project$Typing$Rule, 'xxka', 'っヵ'),
		A2($author$project$Typing$Rule, 'xxke', 'っヶ'),
		A2($author$project$Typing$Rule, 'xxtu', 'っっ'),
		A2($author$project$Typing$Rule, 'xxya', 'っゃ'),
		A2($author$project$Typing$Rule, 'xxyu', 'っゅ'),
		A2($author$project$Typing$Rule, 'xxyo', 'っょ'),
		A2($author$project$Typing$Rule, 'xxwa', 'っゎ'),
		A2($author$project$Typing$Rule, 'kkya', 'っきゃ'),
		A2($author$project$Typing$Rule, 'kkyi', 'っきぃ'),
		A2($author$project$Typing$Rule, 'kkyu', 'っきゅ'),
		A2($author$project$Typing$Rule, 'kkye', 'っきぇ'),
		A2($author$project$Typing$Rule, 'kkyo', 'っきょ'),
		A2($author$project$Typing$Rule, 'kka', 'っか'),
		A2($author$project$Typing$Rule, 'kki', 'っき'),
		A2($author$project$Typing$Rule, 'kku', 'っく'),
		A2($author$project$Typing$Rule, 'kke', 'っけ'),
		A2($author$project$Typing$Rule, 'kko', 'っこ'),
		A2($author$project$Typing$Rule, 'kkwa', 'っくぁ'),
		A2($author$project$Typing$Rule, 'ggya', 'っぎゃ'),
		A2($author$project$Typing$Rule, 'ggyi', 'っぎぃ'),
		A2($author$project$Typing$Rule, 'ggyu', 'っぎゅ'),
		A2($author$project$Typing$Rule, 'ggye', 'っぎぇ'),
		A2($author$project$Typing$Rule, 'ggyo', 'っぎょ'),
		A2($author$project$Typing$Rule, 'gga', 'っが'),
		A2($author$project$Typing$Rule, 'ggi', 'っぎ'),
		A2($author$project$Typing$Rule, 'ggu', 'っぐ'),
		A2($author$project$Typing$Rule, 'gge', 'っげ'),
		A2($author$project$Typing$Rule, 'ggo', 'っご'),
		A2($author$project$Typing$Rule, 'ggwa', 'っぐぁ'),
		A2($author$project$Typing$Rule, 'ggwi', 'っぐぃ'),
		A2($author$project$Typing$Rule, 'ggwu', 'っぐぅ'),
		A2($author$project$Typing$Rule, 'ggwe', 'っぐぇ'),
		A2($author$project$Typing$Rule, 'ggwo', 'っぐぉ'),
		A2($author$project$Typing$Rule, 'ssya', 'っしゃ'),
		A2($author$project$Typing$Rule, 'ssyi', 'っしぃ'),
		A2($author$project$Typing$Rule, 'ssyu', 'っしゅ'),
		A2($author$project$Typing$Rule, 'ssye', 'っしぇ'),
		A2($author$project$Typing$Rule, 'ssyo', 'っしょ'),
		A2($author$project$Typing$Rule, 'ssha', 'っしゃ'),
		A2($author$project$Typing$Rule, 'sshi', 'っし'),
		A2($author$project$Typing$Rule, 'sshu', 'っしゅ'),
		A2($author$project$Typing$Rule, 'sshe', 'っしぇ'),
		A2($author$project$Typing$Rule, 'ssho', 'っしょ'),
		A2($author$project$Typing$Rule, 'ssa', 'っさ'),
		A2($author$project$Typing$Rule, 'ssi', 'っし'),
		A2($author$project$Typing$Rule, 'ssu', 'っす'),
		A2($author$project$Typing$Rule, 'sse', 'っせ'),
		A2($author$project$Typing$Rule, 'sso', 'っそ'),
		A2($author$project$Typing$Rule, 'zzya', 'っじゃ'),
		A2($author$project$Typing$Rule, 'zzyi', 'っじぃ'),
		A2($author$project$Typing$Rule, 'zzyu', 'っじゅ'),
		A2($author$project$Typing$Rule, 'zzye', 'っじぇ'),
		A2($author$project$Typing$Rule, 'zzyo', 'っじょ'),
		A2($author$project$Typing$Rule, 'zza', 'っざ'),
		A2($author$project$Typing$Rule, 'zzi', 'っじ'),
		A2($author$project$Typing$Rule, 'zzu', 'っず'),
		A2($author$project$Typing$Rule, 'zze', 'っぜ'),
		A2($author$project$Typing$Rule, 'zzo', 'っぞ'),
		A2($author$project$Typing$Rule, 'jja', 'っじゃ'),
		A2($author$project$Typing$Rule, 'jji', 'っじ'),
		A2($author$project$Typing$Rule, 'jju', 'っじゅ'),
		A2($author$project$Typing$Rule, 'jje', 'っじぇ'),
		A2($author$project$Typing$Rule, 'jjo', 'っじょ'),
		A2($author$project$Typing$Rule, 'jjya', 'っじゃ'),
		A2($author$project$Typing$Rule, 'jjyi', 'っじぃ'),
		A2($author$project$Typing$Rule, 'jjyu', 'っじゅ'),
		A2($author$project$Typing$Rule, 'jjye', 'っじぇ'),
		A2($author$project$Typing$Rule, 'jjyo', 'っじょ'),
		A2($author$project$Typing$Rule, 'ttya', 'っちゃ'),
		A2($author$project$Typing$Rule, 'ttyi', 'っちぃ'),
		A2($author$project$Typing$Rule, 'ttyu', 'っちゅ'),
		A2($author$project$Typing$Rule, 'ttye', 'っちぇ'),
		A2($author$project$Typing$Rule, 'ttyo', 'っちょ'),
		A2($author$project$Typing$Rule, 'ttsa', 'っつぁ'),
		A2($author$project$Typing$Rule, 'ttsi', 'っつぃ'),
		A2($author$project$Typing$Rule, 'ttse', 'っつぇ'),
		A2($author$project$Typing$Rule, 'ttso', 'っつぉ'),
		A2($author$project$Typing$Rule, 'ttha', 'ってゃ'),
		A2($author$project$Typing$Rule, 'tthi', 'ってぃ'),
		A2($author$project$Typing$Rule, 'tthu', 'ってゅ'),
		A2($author$project$Typing$Rule, 'tthe', 'ってぇ'),
		A2($author$project$Typing$Rule, 'ttho', 'ってょ'),
		A2($author$project$Typing$Rule, 'ttwa', 'っとぁ'),
		A2($author$project$Typing$Rule, 'ttwi', 'っとぃ'),
		A2($author$project$Typing$Rule, 'ttwu', 'っとぅ'),
		A2($author$project$Typing$Rule, 'ttwe', 'っとぇ'),
		A2($author$project$Typing$Rule, 'ttwo', 'っとぉ'),
		A2($author$project$Typing$Rule, 'tta', 'った'),
		A2($author$project$Typing$Rule, 'tti', 'っち'),
		A2($author$project$Typing$Rule, 'ttu', 'っつ'),
		A2($author$project$Typing$Rule, 'ttsu', 'っつ'),
		A2($author$project$Typing$Rule, 'tte', 'って'),
		A2($author$project$Typing$Rule, 'tto', 'っと'),
		A2($author$project$Typing$Rule, 'ddya', 'っぢゃ'),
		A2($author$project$Typing$Rule, 'ddyi', 'っぢぃ'),
		A2($author$project$Typing$Rule, 'ddyu', 'っぢゅ'),
		A2($author$project$Typing$Rule, 'ddye', 'っぢぇ'),
		A2($author$project$Typing$Rule, 'ddyo', 'っぢょ'),
		A2($author$project$Typing$Rule, 'ddha', 'っでゃ'),
		A2($author$project$Typing$Rule, 'ddhi', 'っでぃ'),
		A2($author$project$Typing$Rule, 'ddhu', 'っでゅ'),
		A2($author$project$Typing$Rule, 'ddhe', 'っでぇ'),
		A2($author$project$Typing$Rule, 'ddho', 'っでょ'),
		A2($author$project$Typing$Rule, 'ddwa', 'っどぁ'),
		A2($author$project$Typing$Rule, 'ddwi', 'っどぃ'),
		A2($author$project$Typing$Rule, 'ddwu', 'っどぅ'),
		A2($author$project$Typing$Rule, 'ddwe', 'っどぇ'),
		A2($author$project$Typing$Rule, 'ddwo', 'っどぉ'),
		A2($author$project$Typing$Rule, 'dda', 'っだ'),
		A2($author$project$Typing$Rule, 'ddi', 'っぢ'),
		A2($author$project$Typing$Rule, 'ddu', 'っづ'),
		A2($author$project$Typing$Rule, 'dde', 'っで'),
		A2($author$project$Typing$Rule, 'ddo', 'っど'),
		A2($author$project$Typing$Rule, 'hhya', 'っひゃ'),
		A2($author$project$Typing$Rule, 'hhyi', 'っひぃ'),
		A2($author$project$Typing$Rule, 'hhyu', 'っひゅ'),
		A2($author$project$Typing$Rule, 'hhye', 'っひぇ'),
		A2($author$project$Typing$Rule, 'hhyo', 'っひょ'),
		A2($author$project$Typing$Rule, 'hha', 'っは'),
		A2($author$project$Typing$Rule, 'hhi', 'っひ'),
		A2($author$project$Typing$Rule, 'hhu', 'っふ'),
		A2($author$project$Typing$Rule, 'hhe', 'っへ'),
		A2($author$project$Typing$Rule, 'hho', 'っほ'),
		A2($author$project$Typing$Rule, 'ffa', 'っふぁ'),
		A2($author$project$Typing$Rule, 'ffi', 'っふぃ'),
		A2($author$project$Typing$Rule, 'ffu', 'っふ'),
		A2($author$project$Typing$Rule, 'ffe', 'っふぇ'),
		A2($author$project$Typing$Rule, 'ffo', 'っふぉ'),
		A2($author$project$Typing$Rule, 'ffya', 'っふゃ'),
		A2($author$project$Typing$Rule, 'ffyu', 'っふゅ'),
		A2($author$project$Typing$Rule, 'ffyo', 'っふょ'),
		A2($author$project$Typing$Rule, 'ffu', 'っふ'),
		A2($author$project$Typing$Rule, 'bbya', 'っびゃ'),
		A2($author$project$Typing$Rule, 'bbyi', 'っびぃ'),
		A2($author$project$Typing$Rule, 'bbyu', 'っびゅ'),
		A2($author$project$Typing$Rule, 'bbye', 'っびぇ'),
		A2($author$project$Typing$Rule, 'bbyo', 'っびょ'),
		A2($author$project$Typing$Rule, 'bba', 'っば'),
		A2($author$project$Typing$Rule, 'bbi', 'っび'),
		A2($author$project$Typing$Rule, 'bbu', 'っぶ'),
		A2($author$project$Typing$Rule, 'bbe', 'っべ'),
		A2($author$project$Typing$Rule, 'bbo', 'っぼ'),
		A2($author$project$Typing$Rule, 'ppya', 'っぴゃ'),
		A2($author$project$Typing$Rule, 'ppyi', 'っぴぃ'),
		A2($author$project$Typing$Rule, 'ppyu', 'っぴゅ'),
		A2($author$project$Typing$Rule, 'ppye', 'っぴぇ'),
		A2($author$project$Typing$Rule, 'ppyo', 'っぴょ'),
		A2($author$project$Typing$Rule, 'ppa', 'っぱ'),
		A2($author$project$Typing$Rule, 'ppi', 'っぴ'),
		A2($author$project$Typing$Rule, 'ppu', 'っぷ'),
		A2($author$project$Typing$Rule, 'ppe', 'っぺ'),
		A2($author$project$Typing$Rule, 'ppo', 'っぽ'),
		A2($author$project$Typing$Rule, 'mmya', 'っみゃ'),
		A2($author$project$Typing$Rule, 'mmyi', 'っみぃ'),
		A2($author$project$Typing$Rule, 'mmyu', 'っみゅ'),
		A2($author$project$Typing$Rule, 'mmye', 'っみぇ'),
		A2($author$project$Typing$Rule, 'mmyo', 'っみょ'),
		A2($author$project$Typing$Rule, 'mma', 'っま'),
		A2($author$project$Typing$Rule, 'mmi', 'っみ'),
		A2($author$project$Typing$Rule, 'mmu', 'っむ'),
		A2($author$project$Typing$Rule, 'mme', 'っめ'),
		A2($author$project$Typing$Rule, 'mmo', 'っも'),
		A2($author$project$Typing$Rule, 'yye', 'っいぇ'),
		A2($author$project$Typing$Rule, 'yya', 'っや'),
		A2($author$project$Typing$Rule, 'yyu', 'っゆ'),
		A2($author$project$Typing$Rule, 'yyo', 'っよ'),
		A2($author$project$Typing$Rule, 'rrya', 'っりゃ'),
		A2($author$project$Typing$Rule, 'rryi', 'っりぃ'),
		A2($author$project$Typing$Rule, 'rryu', 'っりゅ'),
		A2($author$project$Typing$Rule, 'rrye', 'っりぇ'),
		A2($author$project$Typing$Rule, 'rryo', 'っりょ'),
		A2($author$project$Typing$Rule, 'rra', 'っら'),
		A2($author$project$Typing$Rule, 'rri', 'っり'),
		A2($author$project$Typing$Rule, 'rru', 'っる'),
		A2($author$project$Typing$Rule, 'rre', 'っれ'),
		A2($author$project$Typing$Rule, 'rro', 'っろ'),
		A2($author$project$Typing$Rule, 'wwu', 'っう'),
		A2($author$project$Typing$Rule, 'wwyi', 'っゐ'),
		A2($author$project$Typing$Rule, 'wwye', 'っゑ'),
		A2($author$project$Typing$Rule, 'wwa', 'っわ'),
		A2($author$project$Typing$Rule, 'wwi', 'っうぃ'),
		A2($author$project$Typing$Rule, 'wwe', 'っうぇ'),
		A2($author$project$Typing$Rule, 'wwo', 'っを'),
		A2($author$project$Typing$Rule, 'wwha', 'っうぁ'),
		A2($author$project$Typing$Rule, 'wwhi', 'っうぃ'),
		A2($author$project$Typing$Rule, 'wwhu', 'っう'),
		A2($author$project$Typing$Rule, 'wwhe', 'っうぇ'),
		A2($author$project$Typing$Rule, 'wwho', 'っうぉ'),
		A2($author$project$Typing$Rule, 'ccha', 'っちゃ'),
		A2($author$project$Typing$Rule, 'cchi', 'っち'),
		A2($author$project$Typing$Rule, 'cchu', 'っちゅ'),
		A2($author$project$Typing$Rule, 'cche', 'っちぇ'),
		A2($author$project$Typing$Rule, 'ccho', 'っちょ'),
		A2($author$project$Typing$Rule, 'ccya', 'っちゃ'),
		A2($author$project$Typing$Rule, 'ccyi', 'っちぃ'),
		A2($author$project$Typing$Rule, 'ccyu', 'っちゅ'),
		A2($author$project$Typing$Rule, 'ccye', 'っちぇ'),
		A2($author$project$Typing$Rule, 'ccyo', 'っちょ'),
		A2($author$project$Typing$Rule, 'cca', 'っか'),
		A2($author$project$Typing$Rule, 'cci', 'っし'),
		A2($author$project$Typing$Rule, 'ccu', 'っく'),
		A2($author$project$Typing$Rule, 'cce', 'っせ'),
		A2($author$project$Typing$Rule, 'cco', 'っこ'),
		A2($author$project$Typing$Rule, 'a', 'a'),
		A2($author$project$Typing$Rule, 'b', 'b'),
		A2($author$project$Typing$Rule, 'c', 'c'),
		A2($author$project$Typing$Rule, 'd', 'd'),
		A2($author$project$Typing$Rule, 'e', 'e'),
		A2($author$project$Typing$Rule, 'f', 'f'),
		A2($author$project$Typing$Rule, 'g', 'g'),
		A2($author$project$Typing$Rule, 'h', 'h'),
		A2($author$project$Typing$Rule, 'i', 'i'),
		A2($author$project$Typing$Rule, 'j', 'j'),
		A2($author$project$Typing$Rule, 'k', 'k'),
		A2($author$project$Typing$Rule, 'l', 'l'),
		A2($author$project$Typing$Rule, 'm', 'm'),
		A2($author$project$Typing$Rule, 'n', 'n'),
		A2($author$project$Typing$Rule, 'o', 'o'),
		A2($author$project$Typing$Rule, 'p', 'p'),
		A2($author$project$Typing$Rule, 'q', 'q'),
		A2($author$project$Typing$Rule, 'r', 'r'),
		A2($author$project$Typing$Rule, 's', 's'),
		A2($author$project$Typing$Rule, 't', 't'),
		A2($author$project$Typing$Rule, 'u', 'u'),
		A2($author$project$Typing$Rule, 'v', 'v'),
		A2($author$project$Typing$Rule, 'w', 'w'),
		A2($author$project$Typing$Rule, 'x', 'x'),
		A2($author$project$Typing$Rule, 'y', 'y'),
		A2($author$project$Typing$Rule, 'z', 'z'),
		A2($author$project$Typing$Rule, 'A', 'A'),
		A2($author$project$Typing$Rule, 'B', 'B'),
		A2($author$project$Typing$Rule, 'C', 'C'),
		A2($author$project$Typing$Rule, 'D', 'D'),
		...
		A2($author$project$Typing$Rule, 'Y', 'Y'),
		A2($author$project$Typing$Rule, 'Z', 'Z'),
		A2($author$project$Typing$Rule, '0', '0'),
		A2($author$project$Typing$Rule, '1', '1'),
		A2($author$project$Typing$Rule, '2', '2'),
		A2($author$project$Typing$Rule, '3', '3'),
		A2($author$project$Typing$Rule, '4', '4'),
		A2($author$project$Typing$Rule, '5', '5'),
		A2($author$project$Typing$Rule, '6', '6'),
		A2($author$project$Typing$Rule, '7', '7'),
		A2($author$project$Typing$Rule, '8', '8'),
		A2($author$project$Typing$Rule, '9', '9'),
		A2($author$project$Typing$Rule, '`', '`'),
		A2($author$project$Typing$Rule, '~', '~'),
		A2($author$project$Typing$Rule, '!', '!'),
		A2($author$project$Typing$Rule, '@', '@'),
		...
		A2($author$project$Typing$Rule, ')', ')'),
		A2($author$project$Typing$Rule, '-', '-'),
		A2($author$project$Typing$Rule, '_', '_'),
		A2($author$project$Typing$Rule, '=', '='),
		A2($author$project$Typing$Rule, '+', '+'),
		A2($author$project$Typing$Rule, '[', '['),
		A2($author$project$Typing$Rule, ']', ']'),
...
var $author$project$Typing$newData = function (words) {
	return A3(
		$author$project$Typing$Data,
		'',
		words,
		A3($author$project$Typing$State, '', $elm$core$Maybe$Nothing, $author$project$Typing$romanTable));
};
var $author$project$Page$TypeLongWord$initInTrial = F2(
	function (wordForView, wordForInput) {
		var typingData = $elm$core$Maybe$Just(
			$author$project$Typing$newData(wordForInput));
					...
					typingData: function () {
						...
						switch (_v1.$) {
							...
							case 'Loaded':
								var lw = _v1.a;
								return $elm$core$Maybe$Just(
									$author$project$Typing$newData(lw.wordForInput));
							default:
								var lw = _v1.a;
								return $elm$core$Maybe$Just(
									$author$project$Typing$newData(lw.wordForInput));
...
var $author$project$Typing$nextData = F2(
...
var $author$project$Typing$typeTo = F2(
	function (input, data) {
		typeTo:
		while (true) {
				...
				if ((!nl) && (!al)) {
					...
					if (_v0.$ === 'Nothing') {
						...
						var $temp$input = input,
							$temp$data = A2($author$project$Typing$nextData, tmp, data);
						input = $temp$input;
						data = $temp$data;
						continue typeTo;
					}
						...
						if (tmpFixed.$ === 'Nothing') {
							return $elm$core$Maybe$Just(
								A3(
									...
									data.fixedWords,
									data.restWords,
									A3($author$project$Typing$State, sumInput, tmpFixed, nextCandidates)));
						} else {
							var tmp = tmpFixed.a;
							return $elm$core$Maybe$Just(
								A2($author$project$Typing$nextData, tmp, data));
						}
					} else {
						return $elm$core$Maybe$Just(
							A3(
					...
					default:
						...
						switch (_v6.$) {
							case 'Waiting':
								...
								var _v7 = A2($author$project$Typing$typeTo, key, typingData);
								if (_v7.$ === 'Nothing') {
									return _Utils_Tuple3(model, $elm$core$Platform$Cmd$none, env);
								} else {
									var d = _v7.a;
							...
							case 'Typing':
								var _v8 = A2($author$project$Typing$typeTo, key, typingData);
								if (_v8.$ === 'Nothing') {
									return _Utils_Tuple3(
										_Utils_update(
											model,
...
var $author$project$Typing2$getState = function (_v0) {
	var data = _v0.a;
	return data.state;
};
...
var $author$project$Typing2$Miss = {$: 'Miss'};
var $author$project$Typing2$Typing = {$: 'Typing'};
var $author$project$Typing2$Finish = {$: 'Finish'};
var $author$project$Typing2$nextData = F2(
	function (fixedRule, _v0) {
		...
		return $author$project$Typing2$Data(
			{
				convertBuf: A3($author$project$Typing2$ConvertBuf, '', $elm$core$Maybe$Nothing, data.rules),
				fixedWords: newFix,
				history: data.history,
				restWords: newRest,
				rules: data.rules,
				state: (!$elm$core$String$length(newRest)) ? $author$project$Typing2$Finish : $author$project$Typing2$Typing
			});
	});
var $author$project$Typing2$typeTo_ = F2(
	function (input, _v0) {
		typeTo_:
		while (true) {
			var data = _v0.a;
			...
			if ((nl > 0) && (!al)) {
				return $author$project$Typing2$Data(
					_Utils_update(
						data,
						{state: $author$project$Typing2$Miss}));
			} else {
				if ((!nl) && (!al)) {
					...
					if (_v1.$ === 'Nothing') {
						...
						var $temp$input = input,
							$temp$_v0 = A2(
							$author$project$Typing2$nextData,
							tmp,
							$author$project$Typing2$Data(data));
						input = $temp$input;
						_v0 = $temp$_v0;
						continue typeTo_;
					}
						...
						if (tmpFixed.$ === 'Nothing') {
							return $author$project$Typing2$Data(
								_Utils_update(
									data,
									{
										convertBuf: A3($author$project$Typing2$ConvertBuf, sumInput, tmpFixed, nextCandidates),
										state: $author$project$Typing2$Typing
									}));
						} else {
							var tmp = tmpFixed.a;
							return A2(
...
var $author$project$Typing2$typeTo = F2(
	function (input, _v0) {
		var data = _v0.a;
		return A2(
			$author$project$Typing2$typeTo_,
			input,
			$author$project$Typing2$Data(
				_Utils_update(
					data,
					{
...
var $author$project$Page$TypeShortWord$updateByCorrect = F4(
	function (key, newTypingData, word, words) {
		...
		var newWord = _Utils_update(
			word,
			{
				inputHistory: _Utils_ap(word.inputHistory, key),
									...
									var _v4 = function () {
										...
										if (_v5.$ === 'Nothing') {
											...
											if (!_v6) {
												...
												var nowS = $author$project$Typing2$getState(nowT);
												var newT = A2($author$project$Typing2$typeTo, key, nowT);
												var newS = $author$project$Typing2$getState(newT);
												switch (nowS.$) {
													case 'Waiting':
														switch (newS.$) {
															case 'Waiting':
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					model.missed ? 'typing-form__missed' : 'typing-form')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Page$TypeShortWord$getSumOfInput = function (words) {
	var f = F2(
		function (w, sum) {
			return sum + $elm$core$String$length(w.inputHistory);
		});
...
var $author$project$Typing2$getHistory = function (_v0) {
	var data = _v0.a;
	return data.history;
};
var $author$project$Page$TypeShortWord$getInputHistory = function (word) {
	return ($elm$core$String$length(word.inputHistory) > 15) ? A2($elm$core$String$right, 15, word.inputHistory) : word.inputHistory;
};
...
var $author$project$Typing2$dropHead = F2(
	function (head, str) {
...
var $author$project$Typing2$makeRomaji_ = F2(
			...
			switch (_v1.$) {
				...
				default:
					if (!candidates.b) {
						...
						var c = candidates.a;
						var cs = candidates.b;
						var input = A2($author$project$Typing2$dropHead, data.convertBuf.inputBuffer, c.input);
						var _v3 = A2(
							$author$project$Typing2$typeTo,
							input,
							$author$project$Typing2$Data(data));
						var nd = _v3.a;
						var rest = function () {
						...
						var nc = A2(
							...
							data.rules);
						var _v4 = A2(
							$author$project$Typing2$makeRomaji_,
							$author$project$Typing2$Data(nd),
							nc);
						if (_v4.$ === 'Nothing') {
							var $temp$_v0 = $author$project$Typing2$Data(data),
								$temp$candidates = cs;
							_v0 = $temp$_v0;
...
var $author$project$Typing2$makeRomaji = function (_v0) {
	var data = _v0.a;
	var candidates = A2(
		$elm$core$List$filter,
		function (r) {
	...
	return A2(
		$elm$core$Maybe$map,
		function (fd) {
			return $author$project$Typing2$getHistory(fd);
		},
		A2(
			$author$project$Typing2$makeRomaji_,
			$author$project$Typing2$Data(
	...
	function (words, word) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(
					words.missed ? 'typing-form__missed' : 'typing-form')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$author$project$Page$TypeShortWord$getInputHistory(word))
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$author$project$Typing2$getHistory(word.typingData))
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A2(
										$elm$core$Maybe$withDefault,
										'Nothing',
										$author$project$Typing2$makeRomaji(word.typingData)))
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
