...
var $author$project$Typing2$getPower = function (max) {
	var f = F2(
		function (m, p) {
			f:
			while (true) {
...
var $author$project$Typing2$getPriority = F2(
	function (rule, prs) {
		getPriority:
		while (true) {
			if (!prs.b) {
...
var $author$project$Typing2$insertLowPriorities = F2(
	function (priorities, rules) {
		...
		var power = $author$project$Typing2$getPower(max);
		return A2(
			$elm$core$List$map,
			function (rule) {
				return _Utils_update(
					rule,
					{
						priority: (rule.priority * power) + A2($author$project$Typing2$getPriority, rule, priorities)
					});
			},
			rules);
	});
...
var $author$project$Typing2$setEfficiency = function (rules) {
...
var $author$project$Typing2$setFavorite = F3(
...
var $author$project$Typing2$setFavoriteKeys = F2(
	function (keys, rules) {
		return A3($author$project$Typing2$setFavorite, $elm$core$String$contains, keys, rules);
	});
var $author$project$Typing2$setFavoriteStart = F2(
	function (keys, rules) {
		return A3($author$project$Typing2$setFavorite, $elm$core$String$startsWith, keys, rules);
	});
var $author$project$Typing2$defaultPriorities = function (rules) {
	return A2(
		$author$project$Typing2$insertLowPriorities,
		A2(
			$author$project$Typing2$setFavoriteStart,
			_List_fromArray(
				['l']),
			$author$project$Typing2$romanTable),
		A2(
			$author$project$Typing2$insertLowPriorities,
			A2(
				$author$project$Typing2$setFavoriteKeys,
				_List_fromArray(
					['cy']),
				$author$project$Typing2$romanTable),
			A2(
				...
				A2(
					$author$project$Typing2$insertLowPriorities,
					$author$project$Typing2$setEfficiency($author$project$Typing2$romanTable),
					A2(
						$author$project$Typing2$insertLowPriorities,
						_List_fromArray(
							[
								A3($author$project$Typing2$PrintRule, 'n', 'ん', 3),
								A3($author$project$Typing2$PrintRule, 'nn', 'ん', 2),
								A3($author$project$Typing2$PrintRule, 'xn', 'ん', 1)
							]),
						rules)))));
};
...
var $author$project$Typing2$newData = F2(
	function (words, rules) {
		...
		return $author$project$Typing2$Data(
			{
				convertBuf: A3(
					$author$project$Typing2$ConvertBuf,
					'',
					$elm$core$Maybe$Nothing,
		...
		return A2(
			...
			function (rule) {
				return _Utils_update(
					rule,
					{
						priority: A2($author$project$Typing2$getPriority, rule, printRules)
					});
			},
			rules);
	});
var $author$project$Page$TypeShortWord$initCustomTypingWords = function (words) {
	var printRules = A2(
		$author$project$Typing2$insertLowPriorities,
		$author$project$Typing2$defaultPriorities($author$project$Typing2$romanTable),
		A2(
			$author$project$Typing2$setPriorities,
			_List_fromArray(
				[
					A3($author$project$Typing2$PrintRule, 'n', 'ん', 3),
					A3($author$project$Typing2$PrintRule, 'xn', 'ん', 2),
	...
	var f = F2(
		function (w, sum) {
			return sum + $elm$core$String$length(
				$author$project$Typing2$getHistory(w.typingData));
		});
...
var $author$project$Page$TypeShortWord$inputHistoryView = function (word) {
	var history1 = $author$project$Typing2$getHistory(word.typingData);
...
var $author$project$Page$TypeShortWord$restRomajiView = F2(
	function (missed, data) {
		var romaji = A2(
			$elm$core$Maybe$withDefault,
			'',
			$author$project$Typing2$makeRomaji(data));
